...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	2de50513          	addi	a0,a0,734 # 1378 <malloc+0xec>
      a2:	00001097          	auipc	ra,0x1
      a6:	e1c080e7          	jalr	-484(ra) # ebe <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2ce50513          	addi	a0,a0,718 # 1378 <malloc+0xec>
      b2:	00001097          	auipc	ra,0x1
      b6:	e14080e7          	jalr	-492(ra) # ec6 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	2c450513          	addi	a0,a0,708 # 1380 <malloc+0xf4>
  ...
  int fd = -1;
      ...
      sbrk(6011);
      fc:	6a85                	lui	s5,0x1
      fe:	77ba8a93          	addi	s5,s5,1915 # 177b <buf.0+0x10b>
    ...
    if(what == 1){
     ...
     292:	33a58593          	addi	a1,a1,826 # 15c8 <malloc+0x33c>
     ...
     2b6:	36650513          	addi	a0,a0,870 # 1618 <malloc+0x38c>
     ...
     300:	07c50513          	addi	a0,a0,124 # 1378 <malloc+0xec>
     ...
     334:	05050513          	addi	a0,a0,80 # 1380 <malloc+0xf4>
     ...
     396:	2de58593          	addi	a1,a1,734 # 1670 <buf.0>
     39a:	854a                	mv	a0,s2
     ...
     3ae:	2c658593          	addi	a1,a1,710 # 1670 <buf.0>
     3b2:	854a                	mv	a0,s2
     ...
     670:	e3c50513          	addi	a0,a0,-452 # 14a8 <malloc+0x21c>
     ...
     69c:	e2858593          	addi	a1,a1,-472 # 14c0 <malloc+0x234>
     ...
     774:	d5050513          	addi	a0,a0,-688 # 14c0 <malloc+0x234>
     778:	00000097          	auipc	ra,0x0
     77c:	71e080e7          	jalr	1822(ra) # e96 <open>
        unlink("x");
     780:	00001517          	auipc	a0,0x1
     784:	d4050513          	addi	a0,a0,-704 # 14c0 <malloc+0x234>
     ...
     79e:	d6e50513          	addi	a0,a0,-658 # 1508 <malloc+0x27c>
     ...
     7e4:	ce058593          	addi	a1,a1,-800 # 14c0 <malloc+0x234>
     ...
     856:	ce650513          	addi	a0,a0,-794 # 1538 <malloc+0x2ac>
     ...
     88c:	cd050513          	addi	a0,a0,-816 # 1558 <malloc+0x2cc>
     ...
     8a6:	cd650513          	addi	a0,a0,-810 # 1578 <malloc+0x2ec>
     ...
     8c0:	ce458593          	addi	a1,a1,-796 # 15a0 <malloc+0x314>
     8c4:	4509                	li	a0,2
     ...
     8dc:	cc858593          	addi	a1,a1,-824 # 15a0 <malloc+0x314>
     8e0:	4509                	li	a0,2
     ...
     9ac:	b6058593          	addi	a1,a1,-1184 # 1508 <malloc+0x27c>
     9b0:	4509                	li	a0,2
     ...
     aa4:	a6858593          	addi	a1,a1,-1432 # 1508 <malloc+0x27c>
     aa8:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f3e:	70e50513          	addi	a0,a0,1806 # 1648 <digits>
     f42:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    100a:	642b8b93          	addi	s7,s7,1602 # 1648 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    114a:	4fa90913          	addi	s2,s2,1274 # 1640 <malloc+0x3b4>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1212:	45a7b783          	ld	a5,1114(a5) # 1668 <freep>
    ...
    1240:	00e6ea63          	bltu	a3,a4,1254 <free+0x50>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    125a:	02059813          	slli	a6,a1,0x20
    125e:	01c85713          	srli	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    126e:	02061593          	slli	a1,a2,0x20
    1272:	01c5d713          	srli	a4,a1,0x1c
  ...
  freep = p;
    ...
    1282:	3ef73523          	sd	a5,1002(a4) # 1668 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12b4:	3b853503          	ld	a0,952(a0) # 1668 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12dc:	39090913          	addi	s2,s2,912 # 1668 <freep>
  if(p == (char*)-1)
    12e0:	5afd                	li	s5,-1
    12e2:	a895                	j	1356 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12e4:	00000797          	auipc	a5,0x0
    12e8:	77478793          	addi	a5,a5,1908 # 1a58 <base>
    12ec:	00000717          	auipc	a4,0x0
    12f0:	36f73e23          	sd	a5,892(a4) # 1668 <freep>
    ...
    12fa:	b7e1                	j	12c2 <malloc+0x36>
      if(p->s.size == nunits)
    12fc:	02e48c63          	beq	s1,a4,1334 <malloc+0xa8>
        p->s.size -= nunits;
    ...
    1318:	34a73a23          	sd	a0,852(a4) # 1668 <freep>
      return (void*)(p + 1);
    ...
    1338:	bff1                	j	1314 <malloc+0x88>
  hp->s.size = nu;
    133a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    133e:	0541                	addi	a0,a0,16
    1340:	00000097          	auipc	ra,0x0
    1344:	ec4080e7          	jalr	-316(ra) # 1204 <free>
  return freep;
    1348:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    134c:	d971                	beqz	a0,1320 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    134e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1350:	4798                	lw	a4,8(a5)
    1352:	fa9775e3          	bgeu	a4,s1,12fc <malloc+0x70>
    if(p == freep)
    1356:	00093703          	ld	a4,0(s2)
    135a:	853e                	mv	a0,a5
    135c:	fef719e3          	bne	a4,a5,134e <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    1360:	8552                	mv	a0,s4
    1362:	00000097          	auipc	ra,0x0
    1366:	b7c080e7          	jalr	-1156(ra) # ede <sbrk>
  if(p == (char*)-1)
    136a:	fd5518e3          	bne	a0,s5,133a <malloc+0xae>
        return 0;
    136e:	4501                	li	a0,0
    1370:	bf45                	j	1320 <malloc+0x94>
