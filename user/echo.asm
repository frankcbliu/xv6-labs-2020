...
main(int argc, char *argv[])
{
  ...
  2e:	7e6a0a13          	addi	s4,s4,2022 # 810 <malloc+0xe8>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	7b058593          	addi	a1,a1,1968 # 818 <malloc+0xf0>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	45250513          	addi	a0,a0,1106 # 828 <digits>
 3de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a6:	386b8b93          	addi	s7,s7,902 # 828 <digits>
 ...
 5e6:	23e90913          	addi	s2,s2,574 # 820 <malloc+0xf8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ae:	1967b783          	ld	a5,406(a5) # 840 <freep>
 ...
 6dc:	00e6ea63          	bltu	a3,a4,6f0 <free+0x50>
{
 ...
 71e:	12f73323          	sd	a5,294(a4) # 840 <freep>
}
 722:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 750:	0f453503          	ld	a0,244(a0) # 840 <freep>
 ...
 778:	0cc90913          	addi	s2,s2,204 # 840 <freep>
  if(p == (char*)-1)
 77c:	5afd                	li	s5,-1
 77e:	a895                	j	7f2 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 780:	00000797          	auipc	a5,0x0
 784:	0c878793          	addi	a5,a5,200 # 848 <base>
 788:	00000717          	auipc	a4,0x0
 78c:	0af73c23          	sd	a5,184(a4) # 840 <freep>
 790:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b4:	08a73823          	sd	a0,144(a4) # 840 <freep>
      return (void*)(p + 1);
