...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	b5250513          	addi	a0,a0,-1198 # 5b90 <malloc+0x3ec>
      46:	00005097          	auipc	ra,0x5
      4a:	6a0080e7          	jalr	1696(ra) # 56e6 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	b3050513          	addi	a0,a0,-1232 # 5bb0 <malloc+0x40c>
      88:	00005097          	auipc	ra,0x5
      8c:	65e080e7          	jalr	1630(ra) # 56e6 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	b2050513          	addi	a0,a0,-1248 # 5bc8 <malloc+0x424>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	b2250513          	addi	a0,a0,-1246 # 5be8 <malloc+0x444>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	aea50513          	addi	a0,a0,-1302 # 5bd0 <malloc+0x42c>
      ee:	00005097          	auipc	ra,0x5
      f2:	5f8080e7          	jalr	1528(ra) # 56e6 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	af650513          	addi	a0,a0,-1290 # 5bf8 <malloc+0x454>
     10a:	00005097          	auipc	ra,0x5
     10e:	5dc080e7          	jalr	1500(ra) # 56e6 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	af450513          	addi	a0,a0,-1292 # 5c20 <malloc+0x47c>
     134:	00005097          	auipc	ra,0x5
     138:	28a080e7          	jalr	650(ra) # 53be <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	ae050513          	addi	a0,a0,-1312 # 5c20 <malloc+0x47c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	adc58593          	addi	a1,a1,-1316 # 5c30 <malloc+0x48c>
     15c:	00005097          	auipc	ra,0x5
     160:	232080e7          	jalr	562(ra) # 538e <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	ab850513          	addi	a0,a0,-1352 # 5c20 <malloc+0x47c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	abc58593          	addi	a1,a1,-1348 # 5c38 <malloc+0x494>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	a8c50513          	addi	a0,a0,-1396 # 5c20 <malloc+0x47c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	a7650513          	addi	a0,a0,-1418 # 5c40 <malloc+0x49c>
     1d2:	00005097          	auipc	ra,0x5
     1d6:	514080e7          	jalr	1300(ra) # 56e6 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000278 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     294:	7b050513          	addi	a0,a0,1968 # 5a40 <malloc+0x29c>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2a8:	79ca8a93          	addi	s5,s5,1948 # 5a40 <malloc+0x29c>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     32a:	94250513          	addi	a0,a0,-1726 # 5c68 <malloc+0x4c4>
     32e:	00005097          	auipc	ra,0x5
     332:	3b8080e7          	jalr	952(ra) # 56e6 <printf>
      exit(1);
     336:	4505                	li	a0,1
     ...
     34e:	93e50513          	addi	a0,a0,-1730 # 5c88 <malloc+0x4e4>
     352:	00005097          	auipc	ra,0x5
     356:	394080e7          	jalr	916(ra) # 56e6 <printf>
        exit(1);
     35a:	4505                	li	a0,1
...
0000000000000364 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     38a:	91aa0a13          	addi	s4,s4,-1766 # 5ca0 <malloc+0x4fc>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     436:	87650513          	addi	a0,a0,-1930 # 5ca8 <malloc+0x504>
     43a:	00005097          	auipc	ra,0x5
     43e:	2ac080e7          	jalr	684(ra) # 56e6 <printf>
      exit(1);
     442:	4505                	li	a0,1
     ...
     454:	87050513          	addi	a0,a0,-1936 # 5cc0 <malloc+0x51c>
     458:	00005097          	auipc	ra,0x5
     45c:	28e080e7          	jalr	654(ra) # 56e6 <printf>
      exit(1);
     460:	4505                	li	a0,1
     ...
     472:	88250513          	addi	a0,a0,-1918 # 5cf0 <malloc+0x54c>
     476:	00005097          	auipc	ra,0x5
     47a:	270080e7          	jalr	624(ra) # 56e6 <printf>
      exit(1);
     47e:	4505                	li	a0,1
     ...
     48c:	89850513          	addi	a0,a0,-1896 # 5d20 <malloc+0x57c>
     490:	00005097          	auipc	ra,0x5
     494:	256080e7          	jalr	598(ra) # 56e6 <printf>
      exit(1);
     498:	4505                	li	a0,1
     ...
     4aa:	88a50513          	addi	a0,a0,-1910 # 5d30 <malloc+0x58c>
     4ae:	00005097          	auipc	ra,0x5
     4b2:	238080e7          	jalr	568(ra) # 56e6 <printf>
      exit(1);
     4b6:	4505                	li	a0,1
...
00000000000004c0 <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4e8:	87ca0a13          	addi	s4,s4,-1924 # 5d60 <malloc+0x5bc>
    n = write(fds[1], "x", 1);
     4ec:	00005a97          	auipc	s5,0x5
     4f0:	74ca8a93          	addi	s5,s5,1868 # 5c38 <malloc+0x494>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     596:	7d650513          	addi	a0,a0,2006 # 5d68 <malloc+0x5c4>
     59a:	00005097          	auipc	ra,0x5
     59e:	14c080e7          	jalr	332(ra) # 56e6 <printf>
      exit(1);
     5a2:	4505                	li	a0,1
     ...
     5b4:	7d050513          	addi	a0,a0,2000 # 5d80 <malloc+0x5dc>
     5b8:	00005097          	auipc	ra,0x5
     5bc:	12e080e7          	jalr	302(ra) # 56e6 <printf>
      exit(1);
     5c0:	4505                	li	a0,1
     ...
     5ce:	75650513          	addi	a0,a0,1878 # 5d20 <malloc+0x57c>
     5d2:	00005097          	auipc	ra,0x5
     5d6:	114080e7          	jalr	276(ra) # 56e6 <printf>
      exit(1);
     5da:	4505                	li	a0,1
     ...
     5e8:	7cc50513          	addi	a0,a0,1996 # 5db0 <malloc+0x60c>
     5ec:	00005097          	auipc	ra,0x5
     5f0:	0fa080e7          	jalr	250(ra) # 56e6 <printf>
      exit(1);
     5f4:	4505                	li	a0,1
     ...
     606:	7c650513          	addi	a0,a0,1990 # 5dc8 <malloc+0x624>
     60a:	00005097          	auipc	ra,0x5
     60e:	0dc080e7          	jalr	220(ra) # 56e6 <printf>
      exit(1);
     612:	4505                	li	a0,1
...
000000000000061c <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     65c:	5d858593          	addi	a1,a1,1496 # 5c30 <malloc+0x48c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     678:	5ac50513          	addi	a0,a0,1452 # 5c20 <malloc+0x47c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6a4:	58050513          	addi	a0,a0,1408 # 5c20 <malloc+0x47c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6b8:	56c50513          	addi	a0,a0,1388 # 5c20 <malloc+0x47c>
  ...
  write(fd1, "abcdef", 6);
     ...
     6f6:	76658593          	addi	a1,a1,1894 # 5e58 <malloc+0x6b4>
     6fa:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     738:	4ec50513          	addi	a0,a0,1260 # 5c20 <malloc+0x47c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     77c:	68050513          	addi	a0,a0,1664 # 5df8 <malloc+0x654>
     780:	00005097          	auipc	ra,0x5
     784:	f66080e7          	jalr	-154(ra) # 56e6 <printf>
    exit(1);
     788:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     798:	68450513          	addi	a0,a0,1668 # 5e18 <malloc+0x674>
     79c:	00005097          	auipc	ra,0x5
     7a0:	f4a080e7          	jalr	-182(ra) # 56e6 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7a4:	8652                	mv	a2,s4
     7a6:	85d6                	mv	a1,s5
     7a8:	00005517          	auipc	a0,0x5
     7ac:	68050513          	addi	a0,a0,1664 # 5e28 <malloc+0x684>
     7b0:	00005097          	auipc	ra,0x5
     7b4:	f36080e7          	jalr	-202(ra) # 56e6 <printf>
    exit(1);
     7b8:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7c8:	68450513          	addi	a0,a0,1668 # 5e48 <malloc+0x6a4>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	f1a080e7          	jalr	-230(ra) # 56e6 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7d4:	8652                	mv	a2,s4
     7d6:	85d6                	mv	a1,s5
     7d8:	00005517          	auipc	a0,0x5
     7dc:	65050513          	addi	a0,a0,1616 # 5e28 <malloc+0x684>
     7e0:	00005097          	auipc	ra,0x5
     7e4:	f06080e7          	jalr	-250(ra) # 56e6 <printf>
    exit(1);
     7e8:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7fa:	66a50513          	addi	a0,a0,1642 # 5e60 <malloc+0x6bc>
     7fe:	00005097          	auipc	ra,0x5
     802:	ee8080e7          	jalr	-280(ra) # 56e6 <printf>
    exit(1);
     806:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     818:	66c50513          	addi	a0,a0,1644 # 5e80 <malloc+0x6dc>
     81c:	00005097          	auipc	ra,0x5
     820:	eca080e7          	jalr	-310(ra) # 56e6 <printf>
    exit(1);
     824:	4505                	li	a0,1
...
000000000000082e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     84c:	65850513          	addi	a0,a0,1624 # 5ea0 <malloc+0x6fc>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     864:	66898993          	addi	s3,s3,1640 # 5ec8 <malloc+0x724>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     868:	00005a97          	auipc	s5,0x5
     86c:	698a8a93          	addi	s5,s5,1688 # 5f00 <malloc+0x75c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8b2:	5f250513          	addi	a0,a0,1522 # 5ea0 <malloc+0x6fc>
  ...
  if(unlink("small") < 0){
     ...
     8ee:	5b650513          	addi	a0,a0,1462 # 5ea0 <malloc+0x6fc>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     918:	59450513          	addi	a0,a0,1428 # 5ea8 <malloc+0x704>
     91c:	00005097          	auipc	ra,0x5
     920:	dca080e7          	jalr	-566(ra) # 56e6 <printf>
    exit(1);
     924:	4505                	li	a0,1
     ...
     934:	5a850513          	addi	a0,a0,1448 # 5ed8 <malloc+0x734>
     938:	00005097          	auipc	ra,0x5
     93c:	dae080e7          	jalr	-594(ra) # 56e6 <printf>
      exit(1);
     940:	4505                	li	a0,1
     ...
     950:	5c450513          	addi	a0,a0,1476 # 5f10 <malloc+0x76c>
     954:	00005097          	auipc	ra,0x5
     958:	d92080e7          	jalr	-622(ra) # 56e6 <printf>
      exit(1);
     95c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     96c:	5d050513          	addi	a0,a0,1488 # 5f38 <malloc+0x794>
     970:	00005097          	auipc	ra,0x5
     974:	d76080e7          	jalr	-650(ra) # 56e6 <printf>
    exit(1);
     978:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     988:	5d450513          	addi	a0,a0,1492 # 5f58 <malloc+0x7b4>
     98c:	00005097          	auipc	ra,0x5
     990:	d5a080e7          	jalr	-678(ra) # 56e6 <printf>
    exit(1);
     994:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9a4:	5d050513          	addi	a0,a0,1488 # 5f70 <malloc+0x7cc>
     9a8:	00005097          	auipc	ra,0x5
     9ac:	d3e080e7          	jalr	-706(ra) # 56e6 <printf>
    exit(1);
     9b0:	4505                	li	a0,1
...
00000000000009ba <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9d6:	5be50513          	addi	a0,a0,1470 # 5f90 <malloc+0x7ec>
  ...
  fd = open("big", O_RDONLY);
     ...
     a28:	56c50513          	addi	a0,a0,1388 # 5f90 <malloc+0x7ec>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a70:	52c50513          	addi	a0,a0,1324 # 5f98 <malloc+0x7f4>
     a74:	00005097          	auipc	ra,0x5
     a78:	c72080e7          	jalr	-910(ra) # 56e6 <printf>
    exit(1);
     a7c:	4505                	li	a0,1
     ...
     a8c:	53050513          	addi	a0,a0,1328 # 5fb8 <malloc+0x814>
     a90:	00005097          	auipc	ra,0x5
     a94:	c56080e7          	jalr	-938(ra) # 56e6 <printf>
      exit(1);
     a98:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     aa8:	53c50513          	addi	a0,a0,1340 # 5fe0 <malloc+0x83c>
     aac:	00005097          	auipc	ra,0x5
     ab0:	c3a080e7          	jalr	-966(ra) # 56e6 <printf>
    exit(1);
     ab4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ad4:	4c050513          	addi	a0,a0,1216 # 5f90 <malloc+0x7ec>
     ...
     afe:	50650513          	addi	a0,a0,1286 # 6000 <malloc+0x85c>
     b02:	00005097          	auipc	ra,0x5
     b06:	be4080e7          	jalr	-1052(ra) # 56e6 <printf>
        exit(1);
     b0a:	4505                	li	a0,1
     ...
     b1a:	51250513          	addi	a0,a0,1298 # 6028 <malloc+0x884>
     b1e:	00005097          	auipc	ra,0x5
     b22:	bc8080e7          	jalr	-1080(ra) # 56e6 <printf>
      exit(1);
     b26:	4505                	li	a0,1
     ...
     b36:	50e50513          	addi	a0,a0,1294 # 6040 <malloc+0x89c>
     b3a:	00005097          	auipc	ra,0x5
     b3e:	bac080e7          	jalr	-1108(ra) # 56e6 <printf>
      exit(1);
     b42:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b52:	51a50513          	addi	a0,a0,1306 # 6068 <malloc+0x8c4>
     b56:	00005097          	auipc	ra,0x5
     b5a:	b90080e7          	jalr	-1136(ra) # 56e6 <printf>
    exit(1);
     b5e:	4505                	li	a0,1
...
0000000000000b68 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b80:	e5c50513          	addi	a0,a0,-420 # 59d8 <malloc+0x234>
  ...
  write(fd, "hello", SZ);
     ...
     b98:	50c58593          	addi	a1,a1,1292 # 60a0 <malloc+0x8fc>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb4:	e2850513          	addi	a0,a0,-472 # 59d8 <malloc+0x234>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bca:	e1250513          	addi	a0,a0,-494 # 59d8 <malloc+0x234>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     be0:	dfc50513          	addi	a0,a0,-516 # 59d8 <malloc+0x234>
  ...
  write(fd1, "yyy", 3);
     ...
     bf4:	4f858593          	addi	a1,a1,1272 # 60e8 <malloc+0x944>
  ...
  unlink("unlinkread");
     ...
     c5c:	d8050513          	addi	a0,a0,-640 # 59d8 <malloc+0x234>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c7c:	40850513          	addi	a0,a0,1032 # 6080 <malloc+0x8dc>
     c80:	00005097          	auipc	ra,0x5
     c84:	a66080e7          	jalr	-1434(ra) # 56e6 <printf>
    exit(1);
     c88:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c98:	41450513          	addi	a0,a0,1044 # 60a8 <malloc+0x904>
     c9c:	00005097          	auipc	ra,0x5
     ca0:	a4a080e7          	jalr	-1462(ra) # 56e6 <printf>
    exit(1);
     ca4:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cb4:	41850513          	addi	a0,a0,1048 # 60c8 <malloc+0x924>
     cb8:	00005097          	auipc	ra,0x5
     cbc:	a2e080e7          	jalr	-1490(ra) # 56e6 <printf>
    exit(1);
     cc0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cd0:	42450513          	addi	a0,a0,1060 # 60f0 <malloc+0x94c>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	a12080e7          	jalr	-1518(ra) # 56e6 <printf>
    exit(1);
     cdc:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     cec:	42850513          	addi	a0,a0,1064 # 6110 <malloc+0x96c>
     cf0:	00005097          	auipc	ra,0x5
     cf4:	9f6080e7          	jalr	-1546(ra) # 56e6 <printf>
    exit(1);
     cf8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d08:	42c50513          	addi	a0,a0,1068 # 6130 <malloc+0x98c>
     d0c:	00005097          	auipc	ra,0x5
     d10:	9da080e7          	jalr	-1574(ra) # 56e6 <printf>
    exit(1);
     d14:	4505                	li	a0,1
...
0000000000000d1e <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6c:	33858593          	addi	a1,a1,824 # 60a0 <malloc+0x8fc>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d8c:	3d058593          	addi	a1,a1,976 # 6158 <malloc+0x9b4>
     d90:	00005517          	auipc	a0,0x5
     d94:	3c050513          	addi	a0,a0,960 # 6150 <malloc+0x9ac>
  ...
  unlink("lf1");
     ...
     da8:	3ac50513          	addi	a0,a0,940 # 6150 <malloc+0x9ac>
     dac:	00004097          	auipc	ra,0x4
     db0:	612080e7          	jalr	1554(ra) # 53be <unlink>
  if(open("lf1", 0) >= 0){
     db4:	4581                	li	a1,0
     db6:	00005517          	auipc	a0,0x5
     dba:	39a50513          	addi	a0,a0,922 # 6150 <malloc+0x9ac>
  ...
  fd = open("lf2", 0);
     ...
     dd0:	38c50513          	addi	a0,a0,908 # 6158 <malloc+0x9b4>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e08:	35458593          	addi	a1,a1,852 # 6158 <malloc+0x9b4>
     e0c:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e1e:	33e50513          	addi	a0,a0,830 # 6158 <malloc+0x9b4>
     e22:	00004097          	auipc	ra,0x4
     e26:	59c080e7          	jalr	1436(ra) # 53be <unlink>
  if(link("lf2", "lf1") >= 0){
     e2a:	00005597          	auipc	a1,0x5
     e2e:	32658593          	addi	a1,a1,806 # 6150 <malloc+0x9ac>
     e32:	00005517          	auipc	a0,0x5
     e36:	32650513          	addi	a0,a0,806 # 6158 <malloc+0x9b4>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e4a:	30a58593          	addi	a1,a1,778 # 6150 <malloc+0x9ac>
     e4e:	00005517          	auipc	a0,0x5
     e52:	41250513          	addi	a0,a0,1042 # 6260 <malloc+0xabc>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e74:	2f050513          	addi	a0,a0,752 # 6160 <malloc+0x9bc>
     e78:	00005097          	auipc	ra,0x5
     e7c:	86e080e7          	jalr	-1938(ra) # 56e6 <printf>
    exit(1);
     e80:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e90:	2ec50513          	addi	a0,a0,748 # 6178 <malloc+0x9d4>
     e94:	00005097          	auipc	ra,0x5
     e98:	852080e7          	jalr	-1966(ra) # 56e6 <printf>
    exit(1);
     e9c:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     eac:	2e850513          	addi	a0,a0,744 # 6190 <malloc+0x9ec>
     eb0:	00005097          	auipc	ra,0x5
     eb4:	836080e7          	jalr	-1994(ra) # 56e6 <printf>
    exit(1);
     eb8:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec8:	2ec50513          	addi	a0,a0,748 # 61b0 <malloc+0xa0c>
     ecc:	00005097          	auipc	ra,0x5
     ed0:	81a080e7          	jalr	-2022(ra) # 56e6 <printf>
    exit(1);
     ed4:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     ee4:	30050513          	addi	a0,a0,768 # 61e0 <malloc+0xa3c>
     ee8:	00004097          	auipc	ra,0x4
     eec:	7fe080e7          	jalr	2046(ra) # 56e6 <printf>
    exit(1);
     ef0:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     f00:	2fc50513          	addi	a0,a0,764 # 61f8 <malloc+0xa54>
     f04:	00004097          	auipc	ra,0x4
     f08:	7e2080e7          	jalr	2018(ra) # 56e6 <printf>
    exit(1);
     f0c:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f1c:	2f850513          	addi	a0,a0,760 # 6210 <malloc+0xa6c>
     f20:	00004097          	auipc	ra,0x4
     f24:	7c6080e7          	jalr	1990(ra) # 56e6 <printf>
    exit(1);
     f28:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f38:	30450513          	addi	a0,a0,772 # 6238 <malloc+0xa94>
     f3c:	00004097          	auipc	ra,0x4
     f40:	7aa080e7          	jalr	1962(ra) # 56e6 <printf>
    exit(1);
     f44:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f54:	31850513          	addi	a0,a0,792 # 6268 <malloc+0xac4>
     f58:	00004097          	auipc	ra,0x4
     f5c:	78e080e7          	jalr	1934(ra) # 56e6 <printf>
    exit(1);
     f60:	4505                	li	a0,1
...
0000000000000f6a <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fba:	2d2a0a13          	addi	s4,s4,722 # 6288 <malloc+0xae4>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    100c:	28050513          	addi	a0,a0,640 # 6288 <malloc+0xae4>
  ...
  for(i = 0; i < N; i++){
    ...
    107c:	21850513          	addi	a0,a0,536 # 6290 <malloc+0xaec>
    1080:	00004097          	auipc	ra,0x4
    1084:	666080e7          	jalr	1638(ra) # 56e6 <printf>
    exit(1);
    1088:	4505                	li	a0,1
    ...
    109c:	21850513          	addi	a0,a0,536 # 62b0 <malloc+0xb0c>
    10a0:	00004097          	auipc	ra,0x4
    10a4:	646080e7          	jalr	1606(ra) # 56e6 <printf>
      exit(1);
    10a8:	4505                	li	a0,1
    ...
    10b8:	21c50513          	addi	a0,a0,540 # 62d0 <malloc+0xb2c>
    10bc:	00004097          	auipc	ra,0x4
    10c0:	62a080e7          	jalr	1578(ra) # 56e6 <printf>
      exit(1);
    10c4:	4505                	li	a0,1
...
00000000000010ce <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10ea:	20a98993          	addi	s3,s3,522 # 62f0 <malloc+0xb4c>
    10ee:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1126:	1de50513          	addi	a0,a0,478 # 6300 <malloc+0xb5c>
    112a:	00004097          	auipc	ra,0x4
    112e:	5bc080e7          	jalr	1468(ra) # 56e6 <printf>
      exit(1);
    1132:	4505                	li	a0,1
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    1192:	a3a98993          	addi	s3,s3,-1478 # 5bc8 <malloc+0x424>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	1a878793          	addi	a5,a5,424 # 73c0 <malloc+0x1c1c>
  ...
  if(pid == 0){
    ...
    1252:	dca78793          	addi	a5,a5,-566 # 8018 <big.0>
    ...
    1278:	8c478793          	addi	a5,a5,-1852 # 7b38 <malloc+0x2394>
    ...
    129c:	93050513          	addi	a0,a0,-1744 # 5bc8 <malloc+0x424>
    ...
    12b4:	0f850513          	addi	a0,a0,248 # 63a8 <malloc+0xc04>
    12b8:	00004097          	auipc	ra,0x4
    12bc:	42e080e7          	jalr	1070(ra) # 56e6 <printf>
      exit(1);
    12c0:	4505                	li	a0,1
    ...
    12d4:	05050513          	addi	a0,a0,80 # 6320 <malloc+0xb7c>
    12d8:	00004097          	auipc	ra,0x4
    12dc:	40e080e7          	jalr	1038(ra) # 56e6 <printf>
    exit(1);
    12e0:	4505                	li	a0,1
    ...
    12f4:	05050513          	addi	a0,a0,80 # 6340 <malloc+0xb9c>
    12f8:	00004097          	auipc	ra,0x4
    12fc:	3ee080e7          	jalr	1006(ra) # 56e6 <printf>
    exit(1);
    1300:	4505                	li	a0,1
    ...
    1316:	04e50513          	addi	a0,a0,78 # 6360 <malloc+0xbbc>
    131a:	00004097          	auipc	ra,0x4
    131e:	3cc080e7          	jalr	972(ra) # 56e6 <printf>
    exit(1);
    1322:	4505                	li	a0,1
    ...
    1336:	05650513          	addi	a0,a0,86 # 6388 <malloc+0xbe4>
    133a:	00004097          	auipc	ra,0x4
    133e:	3ac080e7          	jalr	940(ra) # 56e6 <printf>
    exit(1);
    1342:	4505                	li	a0,1
    ...
    1350:	4a450513          	addi	a0,a0,1188 # 67f0 <malloc+0x104c>
    1354:	00004097          	auipc	ra,0x4
    1358:	392080e7          	jalr	914(ra) # 56e6 <printf>
    exit(1);
    135c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    139a:	03a50513          	addi	a0,a0,58 # 63d0 <malloc+0xc2c>
    139e:	00004097          	auipc	ra,0x4
    13a2:	348080e7          	jalr	840(ra) # 56e6 <printf>
    exit(1);
    13a6:	4505                	li	a0,1
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13cc:	85850513          	addi	a0,a0,-1960 # 5c20 <malloc+0x47c>
  ...
  if(pid == 0){
    ...
    13f6:	82ea0a13          	addi	s4,s4,-2002 # 5c20 <malloc+0x47c>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	036a8a93          	addi	s5,s5,54 # 6430 <malloc+0xc8c>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    146e:	f9650513          	addi	a0,a0,-106 # 6400 <malloc+0xc5c>
    1472:	00004097          	auipc	ra,0x4
    1476:	274080e7          	jalr	628(ra) # 56e6 <printf>
    exit(1);
    147a:	4505                	li	a0,1
    ...
    148a:	f9250513          	addi	a0,a0,-110 # 6418 <malloc+0xc74>
    148e:	00004097          	auipc	ra,0x4
    1492:	258080e7          	jalr	600(ra) # 56e6 <printf>
        exit(1);
    1496:	4505                	li	a0,1
    ...
    14a8:	f9c50513          	addi	a0,a0,-100 # 6440 <malloc+0xc9c>
    14ac:	00004097          	auipc	ra,0x4
    14b0:	23a080e7          	jalr	570(ra) # 56e6 <printf>
        exit(1);
    14b4:	4505                	li	a0,1
    ...
    14c6:	75ea0a13          	addi	s4,s4,1886 # 5c20 <malloc+0x47c>
    int n = write(fd, "xxx", 3);
    14ca:	00005a97          	auipc	s5,0x5
    14ce:	f96a8a93          	addi	s5,s5,-106 # 6460 <malloc+0xcbc>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1518:	70c50513          	addi	a0,a0,1804 # 5c20 <malloc+0x47c>
  ...
  exit(xstatus);
    ...
    1536:	ee650513          	addi	a0,a0,-282 # 6418 <malloc+0xc74>
    153a:	00004097          	auipc	ra,0x4
    153e:	1ac080e7          	jalr	428(ra) # 56e6 <printf>
      exit(1);
    1542:	4505                	li	a0,1
    ...
    1554:	f1850513          	addi	a0,a0,-232 # 6468 <malloc+0xcc4>
    1558:	00004097          	auipc	ra,0x4
    155c:	18e080e7          	jalr	398(ra) # 56e6 <printf>
      exit(1);
    1560:	4505                	li	a0,1
...
000000000000156a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    157c:	65078793          	addi	a5,a5,1616 # 5bc8 <malloc+0x424>
    1580:	fcf43023          	sd	a5,-64(s0)
    1584:	00005797          	auipc	a5,0x5
    1588:	f0478793          	addi	a5,a5,-252 # 6488 <malloc+0xce4>
    158c:	fcf43423          	sd	a5,-56(s0)
    1590:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1594:	00005517          	auipc	a0,0x5
    1598:	efc50513          	addi	a0,a0,-260 # 6490 <malloc+0xcec>
  ...
  if(pid == 0) {
    ...
    15c6:	ece50513          	addi	a0,a0,-306 # 6490 <malloc+0xcec>
    ...
    15e2:	ed250513          	addi	a0,a0,-302 # 64b0 <malloc+0xd0c>
    15e6:	00004097          	auipc	ra,0x4
    15ea:	100080e7          	jalr	256(ra) # 56e6 <printf>
      exit(1);
    15ee:	4505                	li	a0,1
    ...
    15fe:	e0650513          	addi	a0,a0,-506 # 6400 <malloc+0xc5c>
    1602:	00004097          	auipc	ra,0x4
    1606:	0e4080e7          	jalr	228(ra) # 56e6 <printf>
     exit(1);
    160a:	4505                	li	a0,1
    ...
    161a:	e8250513          	addi	a0,a0,-382 # 6498 <malloc+0xcf4>
    161e:	00004097          	auipc	ra,0x4
    1622:	0c8080e7          	jalr	200(ra) # 56e6 <printf>
      exit(1);
    1626:	4505                	li	a0,1
    ...
    1638:	59450513          	addi	a0,a0,1428 # 5bc8 <malloc+0x424>
  ...
  if(xstatus != 0)
    ...
    166c:	e5850513          	addi	a0,a0,-424 # 64c0 <malloc+0xd1c>
    1670:	00004097          	auipc	ra,0x4
    1674:	076080e7          	jalr	118(ra) # 56e6 <printf>
      exit(1);
    1678:	4505                	li	a0,1
    ...
    1688:	e5450513          	addi	a0,a0,-428 # 64d8 <malloc+0xd34>
    168c:	00004097          	auipc	ra,0x4
    1690:	05a080e7          	jalr	90(ra) # 56e6 <printf>
    1694:	b7d1                	j	1658 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    1696:	4581                	li	a1,0
    1698:	00005517          	auipc	a0,0x5
    169c:	df850513          	addi	a0,a0,-520 # 6490 <malloc+0xcec>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16c6:	89650513          	addi	a0,a0,-1898 # 5f58 <malloc+0x7b4>
    16ca:	00004097          	auipc	ra,0x4
    16ce:	01c080e7          	jalr	28(ra) # 56e6 <printf>
    exit(1);
    16d2:	4505                	li	a0,1
    ...
    16e2:	d3a50513          	addi	a0,a0,-710 # 6418 <malloc+0xc74>
    16e6:	00004097          	auipc	ra,0x4
    16ea:	000080e7          	jalr	ra # 56e6 <printf>
    exit(1);
    16ee:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16fc:	d9850513          	addi	a0,a0,-616 # 6490 <malloc+0xcec>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1726:	dce50513          	addi	a0,a0,-562 # 64f0 <malloc+0xd4c>
    172a:	00004097          	auipc	ra,0x4
    172e:	fbc080e7          	jalr	-68(ra) # 56e6 <printf>
    exit(1);
    1732:	4505                	li	a0,1
...
0000000000001746 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e8:	d2450513          	addi	a0,a0,-732 # 6508 <malloc+0xd64>
    17ec:	00004097          	auipc	ra,0x4
    17f0:	efa080e7          	jalr	-262(ra) # 56e6 <printf>
    exit(1);
    17f4:	4505                	li	a0,1
    ...
    1822:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    186e:	cb650513          	addi	a0,a0,-842 # 6520 <malloc+0xd7c>
    1872:	00004097          	auipc	ra,0x4
    1876:	e74080e7          	jalr	-396(ra) # 56e6 <printf>
        exit(1);
    187a:	4505                	li	a0,1
    ...
    188a:	cb250513          	addi	a0,a0,-846 # 6538 <malloc+0xd94>
    188e:	00004097          	auipc	ra,0x4
    1892:	e58080e7          	jalr	-424(ra) # 56e6 <printf>
}
    ...
    18bc:	c9850513          	addi	a0,a0,-872 # 6550 <malloc+0xdac>
    18c0:	00004097          	auipc	ra,0x4
    18c4:	e26080e7          	jalr	-474(ra) # 56e6 <printf>
      exit(1);
    18c8:	4505                	li	a0,1
    ...
    18fc:	c7850513          	addi	a0,a0,-904 # 6570 <malloc+0xdcc>
    1900:	00004097          	auipc	ra,0x4
    1904:	de6080e7          	jalr	-538(ra) # 56e6 <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
0000000000001912 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    196e:	a9650513          	addi	a0,a0,-1386 # 6400 <malloc+0xc5c>
    1972:	00004097          	auipc	ra,0x4
    1976:	d74080e7          	jalr	-652(ra) # 56e6 <printf>
      exit(1);
    197a:	4505                	li	a0,1
    ...
    198a:	c0250513          	addi	a0,a0,-1022 # 6588 <malloc+0xde4>
    198e:	00004097          	auipc	ra,0x4
    1992:	d58080e7          	jalr	-680(ra) # 56e6 <printf>
        exit(1);
    1996:	4505                	li	a0,1
    ...
    19a6:	bfe50513          	addi	a0,a0,-1026 # 65a0 <malloc+0xdfc>
    19aa:	00004097          	auipc	ra,0x4
    19ae:	d3c080e7          	jalr	-708(ra) # 56e6 <printf>
        exit(1);
    19b2:	4505                	li	a0,1
...
00000000000019c6 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a1e:	9e650513          	addi	a0,a0,-1562 # 6400 <malloc+0xc5c>
    1a22:	00004097          	auipc	ra,0x4
    1a26:	cc4080e7          	jalr	-828(ra) # 56e6 <printf>
      exit(1);
    1a2a:	4505                	li	a0,1
    ...
    1a42:	9c250513          	addi	a0,a0,-1598 # 6400 <malloc+0xc5c>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	ca0080e7          	jalr	-864(ra) # 56e6 <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
...
0000000000001a60 <forkfork>:
{
    ...
    1abc:	b0850513          	addi	a0,a0,-1272 # 65c0 <malloc+0xe1c>
    1ac0:	00004097          	auipc	ra,0x4
    1ac4:	c26080e7          	jalr	-986(ra) # 56e6 <printf>
      exit(1);
    1ac8:	4505                	li	a0,1
    ...
    1ace:	8a4080e7          	jalr	-1884(ra) # 536e <exit>
{
    ...
    1b14:	ac050513          	addi	a0,a0,-1344 # 65d0 <malloc+0xe2c>
    1b18:	00004097          	auipc	ra,0x4
    1b1c:	bce080e7          	jalr	-1074(ra) # 56e6 <printf>
      exit(1);
    1b20:	4505                	li	a0,1
...
0000000000001b2a <reparent2>:
{
  ...
  exit(0);
    ...
    1b62:	c9250513          	addi	a0,a0,-878 # 67f0 <malloc+0x104c>
    1b66:	00004097          	auipc	ra,0x4
    1b6a:	b80080e7          	jalr	-1152(ra) # 56e6 <printf>
      exit(1);
    1b6e:	4505                	li	a0,1
...
0000000000001b92 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c00:	bf450513          	addi	a0,a0,-1036 # 67f0 <malloc+0x104c>
    1c04:	00004097          	auipc	ra,0x4
    1c08:	ae2080e7          	jalr	-1310(ra) # 56e6 <printf>
      exit(1);
    1c0c:	4505                	li	a0,1
    ...
    1c2c:	87050513          	addi	a0,a0,-1936 # 6498 <malloc+0xcf4>
    1c30:	00004097          	auipc	ra,0x4
    1c34:	ab6080e7          	jalr	-1354(ra) # 56e6 <printf>
          exit(1);
    1c38:	4505                	li	a0,1
    ...
    1c9e:	95650513          	addi	a0,a0,-1706 # 65f0 <malloc+0xe4c>
    1ca2:	00004097          	auipc	ra,0x4
    1ca6:	a44080e7          	jalr	-1468(ra) # 56e6 <printf>
            exit(1);
    1caa:	4505                	li	a0,1
    ...
    1cd2:	93a50513          	addi	a0,a0,-1734 # 6608 <malloc+0xe64>
    1cd6:	00004097          	auipc	ra,0x4
    1cda:	a10080e7          	jalr	-1520(ra) # 56e6 <printf>
        exit(1);
    1cde:	4505                	li	a0,1
    ...
    1d38:	8fc50513          	addi	a0,a0,-1796 # 6630 <malloc+0xe8c>
    1d3c:	00004097          	auipc	ra,0x4
    1d40:	9aa080e7          	jalr	-1622(ra) # 56e6 <printf>
        exit(1);
    1d44:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    1d64:	0ff97913          	zext.b	s2,s2
    1d68:	2985                	addiw	s3,s3,1
    1d6a:	0ff9f993          	zext.b	s3,s3
...
0000000000001db8 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd8:	e6450513          	addi	a0,a0,-412 # 5c38 <malloc+0x494>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e14:	e28a8a93          	addi	s5,s5,-472 # 5c38 <malloc+0x494>
      link("cat", "x");
    1e18:	00005b97          	auipc	s7,0x5
    1e1c:	840b8b93          	addi	s7,s7,-1984 # 6658 <malloc+0xeb4>
    1e20:	a825                	j	1e58 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e22:	85a6                	mv	a1,s1
    1e24:	00004517          	auipc	a0,0x4
    1e28:	5dc50513          	addi	a0,a0,1500 # 6400 <malloc+0xc5c>
    1e2c:	00004097          	auipc	ra,0x4
    1e30:	8ba080e7          	jalr	-1862(ra) # 56e6 <printf>
    exit(1);
    1e34:	4505                	li	a0,1
...
0000000000001eba <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1eea:	79250513          	addi	a0,a0,1938 # 6678 <malloc+0xed4>
    1eee:	00003097          	auipc	ra,0x3
    1ef2:	7f8080e7          	jalr	2040(ra) # 56e6 <printf>
    exit(1);
    1ef6:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1f4c:	71850513          	addi	a0,a0,1816 # 6660 <malloc+0xebc>
    1f50:	00003097          	auipc	ra,0x3
    1f54:	796080e7          	jalr	1942(ra) # 56e6 <printf>
    exit(1);
    1f58:	4505                	li	a0,1
    ...
    1f68:	73c50513          	addi	a0,a0,1852 # 66a0 <malloc+0xefc>
    1f6c:	00003097          	auipc	ra,0x3
    1f70:	77a080e7          	jalr	1914(ra) # 56e6 <printf>
      exit(1);
    1f74:	4505                	li	a0,1
    ...
    1f84:	73850513          	addi	a0,a0,1848 # 66b8 <malloc+0xf14>
    1f88:	00003097          	auipc	ra,0x3
    1f8c:	75e080e7          	jalr	1886(ra) # 56e6 <printf>
    exit(1);
    1f90:	4505                	li	a0,1
...
0000000000001f9a <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2004:	40050513          	addi	a0,a0,1024 # 6400 <malloc+0xc5c>
    2008:	00003097          	auipc	ra,0x3
    200c:	6de080e7          	jalr	1758(ra) # 56e6 <printf>
      exit(1);
    2010:	4505                	li	a0,1
    ...
    2024:	6b050513          	addi	a0,a0,1712 # 66d0 <malloc+0xf2c>
    2028:	00003097          	auipc	ra,0x3
    202c:	6be080e7          	jalr	1726(ra) # 56e6 <printf>
      exit(1);
    2030:	4505                	li	a0,1
...
0000000000002044 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2054:	6a050513          	addi	a0,a0,1696 # 66f0 <malloc+0xf4c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2086:	66e50513          	addi	a0,a0,1646 # 66f0 <malloc+0xf4c>
  ...
  close(fd);
    ...
    20ac:	e7078793          	addi	a5,a5,-400 # 7f18 <args.1>
    20b0:	00006697          	auipc	a3,0x6
    20b4:	f6068693          	addi	a3,a3,-160 # 8010 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    20b8:	00004717          	auipc	a4,0x4
    20bc:	64870713          	addi	a4,a4,1608 # 6700 <malloc+0xf5c>
    ...
    2110:	6d450513          	addi	a0,a0,1748 # 67e0 <malloc+0x103c>
    2114:	00003097          	auipc	ra,0x3
    2118:	5d2080e7          	jalr	1490(ra) # 56e6 <printf>
    exit(1);
    211c:	4505                	li	a0,1
    ...
    2134:	6d050513          	addi	a0,a0,1744 # 6800 <malloc+0x105c>
    2138:	00003097          	auipc	ra,0x3
    213c:	5ae080e7          	jalr	1454(ra) # 56e6 <printf>
    exit(1);
    2140:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2190:	69450513          	addi	a0,a0,1684 # 6820 <malloc+0x107c>
    2194:	00003097          	auipc	ra,0x3
    2198:	552080e7          	jalr	1362(ra) # 56e6 <printf>
    exit(1);
    219c:	4505                	li	a0,1
    ...
    21ac:	25850513          	addi	a0,a0,600 # 6400 <malloc+0xc5c>
    21b0:	00003097          	auipc	ra,0x3
    21b4:	536080e7          	jalr	1334(ra) # 56e6 <printf>
    exit(1);
    21b8:	4505                	li	a0,1
...
00000000000021cc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2246:	17e78793          	addi	a5,a5,382 # 73c0 <malloc+0x1c1c>
  ...
  if(ret != -1){
    ...
    2288:	5c450513          	addi	a0,a0,1476 # 6848 <malloc+0x10a4>
    228c:	00003097          	auipc	ra,0x3
    2290:	45a080e7          	jalr	1114(ra) # 56e6 <printf>
    exit(1);
    2294:	4505                	li	a0,1
    ...
    22a6:	07e50513          	addi	a0,a0,126 # 6320 <malloc+0xb7c>
    22aa:	00003097          	auipc	ra,0x3
    22ae:	43c080e7          	jalr	1084(ra) # 56e6 <printf>
    exit(1);
    22b2:	4505                	li	a0,1
    ...
    22c4:	08050513          	addi	a0,a0,128 # 6340 <malloc+0xb9c>
    22c8:	00003097          	auipc	ra,0x3
    22cc:	41e080e7          	jalr	1054(ra) # 56e6 <printf>
    exit(1);
    22d0:	4505                	li	a0,1
    ...
    22e4:	08050513          	addi	a0,a0,128 # 6360 <malloc+0xbbc>
    22e8:	00003097          	auipc	ra,0x3
    22ec:	3fe080e7          	jalr	1022(ra) # 56e6 <printf>
    exit(1);
    22f0:	4505                	li	a0,1
    ...
    2302:	08a50513          	addi	a0,a0,138 # 6388 <malloc+0xbe4>
    2306:	00003097          	auipc	ra,0x3
    230a:	3e0080e7          	jalr	992(ra) # 56e6 <printf>
    exit(1);
    230e:	4505                	li	a0,1
...
0000000000002318 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    236e:	4e650513          	addi	a0,a0,1254 # 6850 <malloc+0x10ac>
    2372:	00003097          	auipc	ra,0x3
    2376:	374080e7          	jalr	884(ra) # 56e6 <printf>
    exit(1);
    237a:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    23c0:	4b450513          	addi	a0,a0,1204 # 6870 <malloc+0x10cc>
    23c4:	00003097          	auipc	ra,0x3
    23c8:	322080e7          	jalr	802(ra) # 56e6 <printf>
    exit(1);
    23cc:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2424:	4b050513          	addi	a0,a0,1200 # 68d0 <malloc+0x112c>
    2428:	00003097          	auipc	ra,0x3
    242c:	2be080e7          	jalr	702(ra) # 56e6 <printf>
    exit(1);
    2430:	4505                	li	a0,1
    ...
    2444:	45050513          	addi	a0,a0,1104 # 6890 <malloc+0x10ec>
    2448:	00003097          	auipc	ra,0x3
    244c:	29e080e7          	jalr	670(ra) # 56e6 <printf>
      exit(1);
    2450:	4505                	li	a0,1
    ...
    2460:	45450513          	addi	a0,a0,1108 # 68b0 <malloc+0x110c>
    2464:	00003097          	auipc	ra,0x3
    2468:	282080e7          	jalr	642(ra) # 56e6 <printf>
    exit(1);
    246c:	4505                	li	a0,1
...
000000000000249c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    25aa:	34a50513          	addi	a0,a0,842 # 68f0 <malloc+0x114c>
    25ae:	00003097          	auipc	ra,0x3
    25b2:	138080e7          	jalr	312(ra) # 56e6 <printf>
    exit(1);
    25b6:	4505                	li	a0,1
    ...
    25c6:	37650513          	addi	a0,a0,886 # 6938 <malloc+0x1194>
    25ca:	00003097          	auipc	ra,0x3
    25ce:	11c080e7          	jalr	284(ra) # 56e6 <printf>
    exit(1);
    25d2:	4505                	li	a0,1
    ...
    25e4:	37850513          	addi	a0,a0,888 # 6958 <malloc+0x11b4>
    25e8:	00003097          	auipc	ra,0x3
    25ec:	0fe080e7          	jalr	254(ra) # 56e6 <printf>
    exit(1);
    25f0:	4505                	li	a0,1
    ...
    2602:	39a50513          	addi	a0,a0,922 # 6998 <malloc+0x11f4>
    2606:	00003097          	auipc	ra,0x3
    260a:	0e0080e7          	jalr	224(ra) # 56e6 <printf>
    exit(1);
    260e:	4505                	li	a0,1
    ...
    261e:	3ae50513          	addi	a0,a0,942 # 69c8 <malloc+0x1224>
    2622:	00003097          	auipc	ra,0x3
    2626:	0c4080e7          	jalr	196(ra) # 56e6 <printf>
    exit(1);
    262a:	4505                	li	a0,1
    ...
    263c:	3c850513          	addi	a0,a0,968 # 6a00 <malloc+0x125c>
    2640:	00003097          	auipc	ra,0x3
    2644:	0a6080e7          	jalr	166(ra) # 56e6 <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002652 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2676:	3b650513          	addi	a0,a0,950 # 6a28 <malloc+0x1284>
    267a:	00003097          	auipc	ra,0x3
    267e:	d34080e7          	jalr	-716(ra) # 53ae <open>
    2682:	84aa                	mv	s1,a0
  unlink("sbrk");
    2684:	00004517          	auipc	a0,0x4
    2688:	3a450513          	addi	a0,a0,932 # 6a28 <malloc+0x1284>
  ...
  if(pipe((int *) a) != 0){
    ...
    26dc:	35850513          	addi	a0,a0,856 # 6a30 <malloc+0x128c>
    26e0:	00003097          	auipc	ra,0x3
    26e4:	006080e7          	jalr	6(ra) # 56e6 <printf>
    exit(1);
    26e8:	4505                	li	a0,1
    ...
    26f8:	35450513          	addi	a0,a0,852 # 6a48 <malloc+0x12a4>
    26fc:	00003097          	auipc	ra,0x3
    2700:	fea080e7          	jalr	-22(ra) # 56e6 <printf>
    exit(1);
    2704:	4505                	li	a0,1
    ...
    2714:	df850513          	addi	a0,a0,-520 # 6508 <malloc+0xd64>
    2718:	00003097          	auipc	ra,0x3
    271c:	fce080e7          	jalr	-50(ra) # 56e6 <printf>
    exit(1);
    2720:	4505                	li	a0,1
...
000000000000272a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    273e:	32650513          	addi	a0,a0,806 # 6a60 <malloc+0x12bc>
  ...
  close(fd);
    ...
    2786:	c9650513          	addi	a0,a0,-874 # 6418 <malloc+0xc74>
    278a:	00003097          	auipc	ra,0x3
    278e:	f5c080e7          	jalr	-164(ra) # 56e6 <printf>
    exit(1);
    2792:	4505                	li	a0,1
...
000000000000279c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    27d4:	02050513          	addi	a0,a0,32 # 67f0 <malloc+0x104c>
    27d8:	00003097          	auipc	ra,0x3
    27dc:	f0e080e7          	jalr	-242(ra) # 56e6 <printf>
    exit(1);
    27e0:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    282a:	fca50513          	addi	a0,a0,-54 # 67f0 <malloc+0x104c>
    282e:	00003097          	auipc	ra,0x3
    2832:	eb8080e7          	jalr	-328(ra) # 56e6 <printf>
    exit(1);
    2836:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    288a:	f6a50513          	addi	a0,a0,-150 # 67f0 <malloc+0x104c>
    288e:	00003097          	auipc	ra,0x3
    2892:	e58080e7          	jalr	-424(ra) # 56e6 <printf>
    exit(1);
    2896:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    28f6:	efe50513          	addi	a0,a0,-258 # 67f0 <malloc+0x104c>
    28fa:	00003097          	auipc	ra,0x3
    28fe:	dec080e7          	jalr	-532(ra) # 56e6 <printf>
      exit(1);
    2902:	4505                	li	a0,1
    ...
    294a:	28250513          	addi	a0,a0,642 # 5bc8 <malloc+0x424>
    294e:	faa43c23          	sd	a0,-72(s0)
    2952:	00003797          	auipc	a5,0x3
    2956:	2e678793          	addi	a5,a5,742 # 5c38 <malloc+0x494>
...
0000000000002978 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2988:	2b450513          	addi	a0,a0,692 # 6c38 <malloc+0x1494>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    299a:	0fa50513          	addi	a0,a0,250 # 6a90 <malloc+0x12ec>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29b0:	13c50513          	addi	a0,a0,316 # 6ae8 <malloc+0x1344>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29ce:	19650513          	addi	a0,a0,406 # 6b60 <malloc+0x13bc>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    29ea:	1ea50513          	addi	a0,a0,490 # 6bd0 <malloc+0x142c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    29fc:	23050513          	addi	a0,a0,560 # 6c28 <malloc+0x1484>
  ...
  unlink("12345678901234");
    ...
    2a7a:	ff250513          	addi	a0,a0,-14 # 6a68 <malloc+0x12c4>
    2a7e:	00003097          	auipc	ra,0x3
    2a82:	c68080e7          	jalr	-920(ra) # 56e6 <printf>
    exit(1);
    2a86:	4505                	li	a0,1
    ...
    2a96:	01e50513          	addi	a0,a0,30 # 6ab0 <malloc+0x130c>
    2a9a:	00003097          	auipc	ra,0x3
    2a9e:	c4c080e7          	jalr	-948(ra) # 56e6 <printf>
    exit(1);
    2aa2:	4505                	li	a0,1
    ...
    2ab2:	06a50513          	addi	a0,a0,106 # 6b18 <malloc+0x1374>
    2ab6:	00003097          	auipc	ra,0x3
    2aba:	c30080e7          	jalr	-976(ra) # 56e6 <printf>
    exit(1);
    2abe:	4505                	li	a0,1
    ...
    2ace:	0c650513          	addi	a0,a0,198 # 6b90 <malloc+0x13ec>
    2ad2:	00003097          	auipc	ra,0x3
    2ad6:	c14080e7          	jalr	-1004(ra) # 56e6 <printf>
    exit(1);
    2ada:	4505                	li	a0,1
    ...
    2aea:	10a50513          	addi	a0,a0,266 # 6bf0 <malloc+0x144c>
    2aee:	00003097          	auipc	ra,0x3
    2af2:	bf8080e7          	jalr	-1032(ra) # 56e6 <printf>
    exit(1);
    2af6:	4505                	li	a0,1
    ...
    2b06:	14650513          	addi	a0,a0,326 # 6c48 <malloc+0x14a4>
    2b0a:	00003097          	auipc	ra,0x3
    2b0e:	bdc080e7          	jalr	-1060(ra) # 56e6 <printf>
    exit(1);
    2b12:	4505                	li	a0,1
...
0000000000002b1c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2b2c:	15850513          	addi	a0,a0,344 # 6c80 <malloc+0x14dc>
  ...
  if(chdir("iputdir") < 0){
    ...
    2b40:	14450513          	addi	a0,a0,324 # 6c80 <malloc+0x14dc>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2b54:	17050513          	addi	a0,a0,368 # 6cc0 <malloc+0x151c>
  ...
  if(chdir("/") < 0){
    ...
    2b68:	18c50513          	addi	a0,a0,396 # 6cf0 <malloc+0x154c>
    ...
    2b88:	10450513          	addi	a0,a0,260 # 6c88 <malloc+0x14e4>
    2b8c:	00003097          	auipc	ra,0x3
    2b90:	b5a080e7          	jalr	-1190(ra) # 56e6 <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba4:	10050513          	addi	a0,a0,256 # 6ca0 <malloc+0x14fc>
    2ba8:	00003097          	auipc	ra,0x3
    2bac:	b3e080e7          	jalr	-1218(ra) # 56e6 <printf>
    exit(1);
    2bb0:	4505                	li	a0,1
    ...
    2bc0:	11450513          	addi	a0,a0,276 # 6cd0 <malloc+0x152c>
    2bc4:	00003097          	auipc	ra,0x3
    2bc8:	b22080e7          	jalr	-1246(ra) # 56e6 <printf>
    exit(1);
    2bcc:	4505                	li	a0,1
    ...
    2bdc:	12050513          	addi	a0,a0,288 # 6cf8 <malloc+0x1554>
    2be0:	00003097          	auipc	ra,0x3
    2be4:	b06080e7          	jalr	-1274(ra) # 56e6 <printf>
    exit(1);
    2be8:	4505                	li	a0,1
...
0000000000002bf2 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c10:	07450513          	addi	a0,a0,116 # 6c80 <malloc+0x14dc>
    ...
    2c24:	06050513          	addi	a0,a0,96 # 6c80 <malloc+0x14dc>
    ...
    2c38:	08c50513          	addi	a0,a0,140 # 6cc0 <malloc+0x151c>
    ...
    2c58:	7ac50513          	addi	a0,a0,1964 # 6400 <malloc+0xc5c>
    2c5c:	00003097          	auipc	ra,0x3
    2c60:	a8a080e7          	jalr	-1398(ra) # 56e6 <printf>
    exit(1);
    2c64:	4505                	li	a0,1
    ...
    2c74:	01850513          	addi	a0,a0,24 # 6c88 <malloc+0x14e4>
    2c78:	00003097          	auipc	ra,0x3
    2c7c:	a6e080e7          	jalr	-1426(ra) # 56e6 <printf>
      exit(1);
    2c80:	4505                	li	a0,1
    ...
    2c90:	08450513          	addi	a0,a0,132 # 6d10 <malloc+0x156c>
    2c94:	00003097          	auipc	ra,0x3
    2c98:	a52080e7          	jalr	-1454(ra) # 56e6 <printf>
      exit(1);
    2c9c:	4505                	li	a0,1
    ...
    2cac:	02850513          	addi	a0,a0,40 # 6cd0 <malloc+0x152c>
    2cb0:	00003097          	auipc	ra,0x3
    2cb4:	a36080e7          	jalr	-1482(ra) # 56e6 <printf>
      exit(1);
    2cb8:	4505                	li	a0,1
...
0000000000002cda <subdir>:
{
  ...
  unlink("ff");
    ...
    2cec:	17050513          	addi	a0,a0,368 # 6e58 <malloc+0x16b4>
    2cf0:	00002097          	auipc	ra,0x2
    2cf4:	6ce080e7          	jalr	1742(ra) # 53be <unlink>
  if(mkdir("dd") != 0){
    2cf8:	00004517          	auipc	a0,0x4
    2cfc:	03050513          	addi	a0,a0,48 # 6d28 <malloc+0x1584>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d14:	03850513          	addi	a0,a0,56 # 6d48 <malloc+0x15a4>
  ...
  write(fd, "ff", 2);
    ...
    2d2c:	13058593          	addi	a1,a1,304 # 6e58 <malloc+0x16b4>
  ...
  if(unlink("dd") >= 0){
    ...
    2d46:	fe650513          	addi	a0,a0,-26 # 6d28 <malloc+0x1584>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2d5a:	04a50513          	addi	a0,a0,74 # 6da0 <malloc+0x15fc>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d72:	05a50513          	addi	a0,a0,90 # 6dc8 <malloc+0x1624>
  ...
  write(fd, "FF", 2);
    ...
    2d8a:	07258593          	addi	a1,a1,114 # 6df8 <malloc+0x1654>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da6:	05e50513          	addi	a0,a0,94 # 6e00 <malloc+0x165c>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2dee:	06658593          	addi	a1,a1,102 # 6e50 <malloc+0x16ac>
    2df2:	00004517          	auipc	a0,0x4
    2df6:	fd650513          	addi	a0,a0,-42 # 6dc8 <malloc+0x1624>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2e0a:	fc250513          	addi	a0,a0,-62 # 6dc8 <malloc+0x1624>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e20:	fac50513          	addi	a0,a0,-84 # 6dc8 <malloc+0x1624>
  ...
  if(chdir("dd") != 0){
    ...
    2e34:	ef850513          	addi	a0,a0,-264 # 6d28 <malloc+0x1584>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2e48:	0a450513          	addi	a0,a0,164 # 6ee8 <malloc+0x1744>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2e5c:	0c050513          	addi	a0,a0,192 # 6f18 <malloc+0x1774>
  ...
  if(chdir("./..") != 0){
    ...
    2e70:	0dc50513          	addi	a0,a0,220 # 6f48 <malloc+0x17a4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2e86:	fce50513          	addi	a0,a0,-50 # 6e50 <malloc+0x16ac>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2ec0:	f0c50513          	addi	a0,a0,-244 # 6dc8 <malloc+0x1624>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2ed8:	10450513          	addi	a0,a0,260 # 6fd8 <malloc+0x1834>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2ef0:	11c50513          	addi	a0,a0,284 # 7008 <malloc+0x1864>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2f08:	e2450513          	addi	a0,a0,-476 # 6d28 <malloc+0x1584>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2f1e:	e0e50513          	addi	a0,a0,-498 # 6d28 <malloc+0x1584>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2f34:	df850513          	addi	a0,a0,-520 # 6d28 <malloc+0x1584>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2f48:	15458593          	addi	a1,a1,340 # 7098 <malloc+0x18f4>
    2f4c:	00004517          	auipc	a0,0x4
    2f50:	08c50513          	addi	a0,a0,140 # 6fd8 <malloc+0x1834>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2f64:	13858593          	addi	a1,a1,312 # 7098 <malloc+0x18f4>
    2f68:	00004517          	auipc	a0,0x4
    2f6c:	0a050513          	addi	a0,a0,160 # 7008 <malloc+0x1864>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2f80:	ed458593          	addi	a1,a1,-300 # 6e50 <malloc+0x16ac>
    2f84:	00004517          	auipc	a0,0x4
    2f88:	dc450513          	addi	a0,a0,-572 # 6d48 <malloc+0x15a4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2f9c:	04050513          	addi	a0,a0,64 # 6fd8 <malloc+0x1834>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2fb0:	05c50513          	addi	a0,a0,92 # 7008 <malloc+0x1864>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2fc4:	e9050513          	addi	a0,a0,-368 # 6e50 <malloc+0x16ac>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2fd8:	03450513          	addi	a0,a0,52 # 7008 <malloc+0x1864>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2fec:	ff050513          	addi	a0,a0,-16 # 6fd8 <malloc+0x1834>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3000:	d4c50513          	addi	a0,a0,-692 # 6d48 <malloc+0x15a4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3014:	1d850513          	addi	a0,a0,472 # 71e8 <malloc+0x1a44>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3028:	e2c50513          	addi	a0,a0,-468 # 6e50 <malloc+0x16ac>
  ...
  if(unlink("dd/ff") != 0){
    ...
    303c:	d1050513          	addi	a0,a0,-752 # 6d48 <malloc+0x15a4>
  ...
  if(unlink("dd") == 0){
    ...
    3050:	cdc50513          	addi	a0,a0,-804 # 6d28 <malloc+0x1584>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3064:	1f850513          	addi	a0,a0,504 # 7258 <malloc+0x1ab4>
  ...
  if(unlink("dd") < 0){
    ...
    3078:	cb450513          	addi	a0,a0,-844 # 6d28 <malloc+0x1584>
    ...
    309a:	c9a50513          	addi	a0,a0,-870 # 6d30 <malloc+0x158c>
    309e:	00002097          	auipc	ra,0x2
    30a2:	648080e7          	jalr	1608(ra) # 56e6 <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b6:	c9e50513          	addi	a0,a0,-866 # 6d50 <malloc+0x15ac>
    30ba:	00002097          	auipc	ra,0x2
    30be:	62c080e7          	jalr	1580(ra) # 56e6 <printf>
    exit(1);
    30c2:	4505                	li	a0,1
    ...
    30d2:	ca250513          	addi	a0,a0,-862 # 6d70 <malloc+0x15cc>
    30d6:	00002097          	auipc	ra,0x2
    30da:	610080e7          	jalr	1552(ra) # 56e6 <printf>
    exit(1);
    30de:	4505                	li	a0,1
    ...
    30ee:	cbe50513          	addi	a0,a0,-834 # 6da8 <malloc+0x1604>
    30f2:	00002097          	auipc	ra,0x2
    30f6:	5f4080e7          	jalr	1524(ra) # 56e6 <printf>
    exit(1);
    30fa:	4505                	li	a0,1
    ...
    310a:	cd250513          	addi	a0,a0,-814 # 6dd8 <malloc+0x1634>
    310e:	00002097          	auipc	ra,0x2
    3112:	5d8080e7          	jalr	1496(ra) # 56e6 <printf>
    exit(1);
    3116:	4505                	li	a0,1
    ...
    3126:	cee50513          	addi	a0,a0,-786 # 6e10 <malloc+0x166c>
    312a:	00002097          	auipc	ra,0x2
    312e:	5bc080e7          	jalr	1468(ra) # 56e6 <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    3142:	cf250513          	addi	a0,a0,-782 # 6e30 <malloc+0x168c>
    3146:	00002097          	auipc	ra,0x2
    314a:	5a0080e7          	jalr	1440(ra) # 56e6 <printf>
    exit(1);
    314e:	4505                	li	a0,1
    ...
    315e:	d0650513          	addi	a0,a0,-762 # 6e60 <malloc+0x16bc>
    3162:	00002097          	auipc	ra,0x2
    3166:	584080e7          	jalr	1412(ra) # 56e6 <printf>
    exit(1);
    316a:	4505                	li	a0,1
    ...
    317a:	d1250513          	addi	a0,a0,-750 # 6e88 <malloc+0x16e4>
    317e:	00002097          	auipc	ra,0x2
    3182:	568080e7          	jalr	1384(ra) # 56e6 <printf>
    exit(1);
    3186:	4505                	li	a0,1
    ...
    3196:	d1650513          	addi	a0,a0,-746 # 6ea8 <malloc+0x1704>
    319a:	00002097          	auipc	ra,0x2
    319e:	54c080e7          	jalr	1356(ra) # 56e6 <printf>
    exit(1);
    31a2:	4505                	li	a0,1
    ...
    31b2:	d2250513          	addi	a0,a0,-734 # 6ed0 <malloc+0x172c>
    31b6:	00002097          	auipc	ra,0x2
    31ba:	530080e7          	jalr	1328(ra) # 56e6 <printf>
    exit(1);
    31be:	4505                	li	a0,1
    ...
    31ce:	d2e50513          	addi	a0,a0,-722 # 6ef8 <malloc+0x1754>
    31d2:	00002097          	auipc	ra,0x2
    31d6:	514080e7          	jalr	1300(ra) # 56e6 <printf>
    exit(1);
    31da:	4505                	li	a0,1
    ...
    31ea:	d4250513          	addi	a0,a0,-702 # 6f28 <malloc+0x1784>
    31ee:	00002097          	auipc	ra,0x2
    31f2:	4f8080e7          	jalr	1272(ra) # 56e6 <printf>
    exit(1);
    31f6:	4505                	li	a0,1
    ...
    3206:	d4e50513          	addi	a0,a0,-690 # 6f50 <malloc+0x17ac>
    320a:	00002097          	auipc	ra,0x2
    320e:	4dc080e7          	jalr	1244(ra) # 56e6 <printf>
    exit(1);
    3212:	4505                	li	a0,1
    ...
    3222:	d4a50513          	addi	a0,a0,-694 # 6f68 <malloc+0x17c4>
    3226:	00002097          	auipc	ra,0x2
    322a:	4c0080e7          	jalr	1216(ra) # 56e6 <printf>
    exit(1);
    322e:	4505                	li	a0,1
    ...
    323e:	d4e50513          	addi	a0,a0,-690 # 6f88 <malloc+0x17e4>
    3242:	00002097          	auipc	ra,0x2
    3246:	4a4080e7          	jalr	1188(ra) # 56e6 <printf>
    exit(1);
    324a:	4505                	li	a0,1
    ...
    325a:	d5250513          	addi	a0,a0,-686 # 6fa8 <malloc+0x1804>
    325e:	00002097          	auipc	ra,0x2
    3262:	488080e7          	jalr	1160(ra) # 56e6 <printf>
    exit(1);
    3266:	4505                	li	a0,1
    ...
    3276:	d7650513          	addi	a0,a0,-650 # 6fe8 <malloc+0x1844>
    327a:	00002097          	auipc	ra,0x2
    327e:	46c080e7          	jalr	1132(ra) # 56e6 <printf>
    exit(1);
    3282:	4505                	li	a0,1
    ...
    3292:	d8a50513          	addi	a0,a0,-630 # 7018 <malloc+0x1874>
    3296:	00002097          	auipc	ra,0x2
    329a:	450080e7          	jalr	1104(ra) # 56e6 <printf>
    exit(1);
    329e:	4505                	li	a0,1
    ...
    32ae:	d8e50513          	addi	a0,a0,-626 # 7038 <malloc+0x1894>
    32b2:	00002097          	auipc	ra,0x2
    32b6:	434080e7          	jalr	1076(ra) # 56e6 <printf>
    exit(1);
    32ba:	4505                	li	a0,1
    ...
    32ca:	d9250513          	addi	a0,a0,-622 # 7058 <malloc+0x18b4>
    32ce:	00002097          	auipc	ra,0x2
    32d2:	418080e7          	jalr	1048(ra) # 56e6 <printf>
    exit(1);
    32d6:	4505                	li	a0,1
    ...
    32e6:	d9650513          	addi	a0,a0,-618 # 7078 <malloc+0x18d4>
    32ea:	00002097          	auipc	ra,0x2
    32ee:	3fc080e7          	jalr	1020(ra) # 56e6 <printf>
    exit(1);
    32f2:	4505                	li	a0,1
    ...
    3302:	daa50513          	addi	a0,a0,-598 # 70a8 <malloc+0x1904>
    3306:	00002097          	auipc	ra,0x2
    330a:	3e0080e7          	jalr	992(ra) # 56e6 <printf>
    exit(1);
    330e:	4505                	li	a0,1
    ...
    331e:	db650513          	addi	a0,a0,-586 # 70d0 <malloc+0x192c>
    3322:	00002097          	auipc	ra,0x2
    3326:	3c4080e7          	jalr	964(ra) # 56e6 <printf>
    exit(1);
    332a:	4505                	li	a0,1
    ...
    333a:	dc250513          	addi	a0,a0,-574 # 70f8 <malloc+0x1954>
    333e:	00002097          	auipc	ra,0x2
    3342:	3a8080e7          	jalr	936(ra) # 56e6 <printf>
    exit(1);
    3346:	4505                	li	a0,1
    ...
    3356:	dce50513          	addi	a0,a0,-562 # 7120 <malloc+0x197c>
    335a:	00002097          	auipc	ra,0x2
    335e:	38c080e7          	jalr	908(ra) # 56e6 <printf>
    exit(1);
    3362:	4505                	li	a0,1
    ...
    3372:	dd250513          	addi	a0,a0,-558 # 7140 <malloc+0x199c>
    3376:	00002097          	auipc	ra,0x2
    337a:	370080e7          	jalr	880(ra) # 56e6 <printf>
    exit(1);
    337e:	4505                	li	a0,1
    ...
    338e:	dd650513          	addi	a0,a0,-554 # 7160 <malloc+0x19bc>
    3392:	00002097          	auipc	ra,0x2
    3396:	354080e7          	jalr	852(ra) # 56e6 <printf>
    exit(1);
    339a:	4505                	li	a0,1
    ...
    33aa:	de250513          	addi	a0,a0,-542 # 7188 <malloc+0x19e4>
    33ae:	00002097          	auipc	ra,0x2
    33b2:	338080e7          	jalr	824(ra) # 56e6 <printf>
    exit(1);
    33b6:	4505                	li	a0,1
    ...
    33c6:	de650513          	addi	a0,a0,-538 # 71a8 <malloc+0x1a04>
    33ca:	00002097          	auipc	ra,0x2
    33ce:	31c080e7          	jalr	796(ra) # 56e6 <printf>
    exit(1);
    33d2:	4505                	li	a0,1
    ...
    33e2:	dea50513          	addi	a0,a0,-534 # 71c8 <malloc+0x1a24>
    33e6:	00002097          	auipc	ra,0x2
    33ea:	300080e7          	jalr	768(ra) # 56e6 <printf>
    exit(1);
    33ee:	4505                	li	a0,1
    ...
    33fe:	df650513          	addi	a0,a0,-522 # 71f0 <malloc+0x1a4c>
    3402:	00002097          	auipc	ra,0x2
    3406:	2e4080e7          	jalr	740(ra) # 56e6 <printf>
    exit(1);
    340a:	4505                	li	a0,1
    ...
    341a:	a7250513          	addi	a0,a0,-1422 # 6e88 <malloc+0x16e4>
    341e:	00002097          	auipc	ra,0x2
    3422:	2c8080e7          	jalr	712(ra) # 56e6 <printf>
    exit(1);
    3426:	4505                	li	a0,1
    ...
    3436:	dde50513          	addi	a0,a0,-546 # 7210 <malloc+0x1a6c>
    343a:	00002097          	auipc	ra,0x2
    343e:	2ac080e7          	jalr	684(ra) # 56e6 <printf>
    exit(1);
    3442:	4505                	li	a0,1
    ...
    3452:	de250513          	addi	a0,a0,-542 # 7230 <malloc+0x1a8c>
    3456:	00002097          	auipc	ra,0x2
    345a:	290080e7          	jalr	656(ra) # 56e6 <printf>
    exit(1);
    345e:	4505                	li	a0,1
    ...
    346e:	df650513          	addi	a0,a0,-522 # 7260 <malloc+0x1abc>
    3472:	00002097          	auipc	ra,0x2
    3476:	274080e7          	jalr	628(ra) # 56e6 <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	dfa50513          	addi	a0,a0,-518 # 7280 <malloc+0x1adc>
    348e:	00002097          	auipc	ra,0x2
    3492:	258080e7          	jalr	600(ra) # 56e6 <printf>
    exit(1);
    3496:	4505                	li	a0,1
...
00000000000034a0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    34b0:	dec50513          	addi	a0,a0,-532 # 7298 <malloc+0x1af4>
  ...
  if(chdir("dots") != 0){
    ...
    34c2:	dda50513          	addi	a0,a0,-550 # 7298 <malloc+0x1af4>
  ...
  if(unlink(".") == 0){
    ...
    34d4:	d9050513          	addi	a0,a0,-624 # 6260 <malloc+0xabc>
  ...
  if(unlink("..") == 0){
    ...
    34e6:	e0650513          	addi	a0,a0,-506 # 72e8 <malloc+0x1b44>
  ...
  if(chdir("/") != 0){
    ...
    34f8:	7fc50513          	addi	a0,a0,2044 # 6cf0 <malloc+0x154c>
  ...
  if(unlink("dots/.") == 0){
    ...
    350a:	e0250513          	addi	a0,a0,-510 # 7308 <malloc+0x1b64>
  ...
  if(unlink("dots/..") == 0){
    ...
    351c:	e1850513          	addi	a0,a0,-488 # 7330 <malloc+0x1b8c>
  ...
  if(unlink("dots") != 0){
    ...
    352e:	d6e50513          	addi	a0,a0,-658 # 7298 <malloc+0x1af4>
    ...
    354c:	d5850513          	addi	a0,a0,-680 # 72a0 <malloc+0x1afc>
    3550:	00002097          	auipc	ra,0x2
    3554:	196080e7          	jalr	406(ra) # 56e6 <printf>
    exit(1);
    3558:	4505                	li	a0,1
    ...
    3568:	d5450513          	addi	a0,a0,-684 # 72b8 <malloc+0x1b14>
    356c:	00002097          	auipc	ra,0x2
    3570:	17a080e7          	jalr	378(ra) # 56e6 <printf>
    exit(1);
    3574:	4505                	li	a0,1
    ...
    3584:	d5050513          	addi	a0,a0,-688 # 72d0 <malloc+0x1b2c>
    3588:	00002097          	auipc	ra,0x2
    358c:	15e080e7          	jalr	350(ra) # 56e6 <printf>
    exit(1);
    3590:	4505                	li	a0,1
    ...
    35a0:	d5450513          	addi	a0,a0,-684 # 72f0 <malloc+0x1b4c>
    35a4:	00002097          	auipc	ra,0x2
    35a8:	142080e7          	jalr	322(ra) # 56e6 <printf>
    exit(1);
    35ac:	4505                	li	a0,1
    ...
    35bc:	74050513          	addi	a0,a0,1856 # 6cf8 <malloc+0x1554>
    35c0:	00002097          	auipc	ra,0x2
    35c4:	126080e7          	jalr	294(ra) # 56e6 <printf>
    exit(1);
    35c8:	4505                	li	a0,1
    ...
    35d8:	d3c50513          	addi	a0,a0,-708 # 7310 <malloc+0x1b6c>
    35dc:	00002097          	auipc	ra,0x2
    35e0:	10a080e7          	jalr	266(ra) # 56e6 <printf>
    exit(1);
    35e4:	4505                	li	a0,1
    ...
    35f4:	d4850513          	addi	a0,a0,-696 # 7338 <malloc+0x1b94>
    35f8:	00002097          	auipc	ra,0x2
    35fc:	0ee080e7          	jalr	238(ra) # 56e6 <printf>
    exit(1);
    3600:	4505                	li	a0,1
    ...
    3610:	d4c50513          	addi	a0,a0,-692 # 7358 <malloc+0x1bb4>
    3614:	00002097          	auipc	ra,0x2
    3618:	0d2080e7          	jalr	210(ra) # 56e6 <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003626 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    363c:	53050513          	addi	a0,a0,1328 # 5b68 <malloc+0x3c4>
  ...
  if(chdir("dirfile") == 0){
    ...
    3658:	51450513          	addi	a0,a0,1300 # 5b68 <malloc+0x3c4>
  ...
  fd = open("dirfile/xx", 0);
    ...
    366c:	d5050513          	addi	a0,a0,-688 # 73b8 <malloc+0x1c14>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3684:	d3850513          	addi	a0,a0,-712 # 73b8 <malloc+0x1c14>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3698:	d2450513          	addi	a0,a0,-732 # 73b8 <malloc+0x1c14>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    36ac:	d1050513          	addi	a0,a0,-752 # 73b8 <malloc+0x1c14>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    36c0:	cfc58593          	addi	a1,a1,-772 # 73b8 <malloc+0x1c14>
    36c4:	00002517          	auipc	a0,0x2
    36c8:	69c50513          	addi	a0,a0,1692 # 5d60 <malloc+0x5bc>
  ...
  if(unlink("dirfile") != 0){
    ...
    36dc:	49050513          	addi	a0,a0,1168 # 5b68 <malloc+0x3c4>
  ...
  fd = open(".", O_RDWR);
    ...
    36f2:	b7250513          	addi	a0,a0,-1166 # 6260 <malloc+0xabc>
  ...
  fd = open(".", 0);
    ...
    3708:	b5c50513          	addi	a0,a0,-1188 # 6260 <malloc+0xabc>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    371c:	52058593          	addi	a1,a1,1312 # 5c38 <malloc+0x494>
  ...
  close(fd);
    ...
    3748:	c3450513          	addi	a0,a0,-972 # 7378 <malloc+0x1bd4>
    374c:	00002097          	auipc	ra,0x2
    3750:	f9a080e7          	jalr	-102(ra) # 56e6 <printf>
    exit(1);
    3754:	4505                	li	a0,1
    ...
    3764:	c3850513          	addi	a0,a0,-968 # 7398 <malloc+0x1bf4>
    3768:	00002097          	auipc	ra,0x2
    376c:	f7e080e7          	jalr	-130(ra) # 56e6 <printf>
    exit(1);
    3770:	4505                	li	a0,1
    ...
    3780:	c4c50513          	addi	a0,a0,-948 # 73c8 <malloc+0x1c24>
    3784:	00002097          	auipc	ra,0x2
    3788:	f62080e7          	jalr	-158(ra) # 56e6 <printf>
    exit(1);
    378c:	4505                	li	a0,1
    ...
    379c:	c3050513          	addi	a0,a0,-976 # 73c8 <malloc+0x1c24>
    37a0:	00002097          	auipc	ra,0x2
    37a4:	f46080e7          	jalr	-186(ra) # 56e6 <printf>
    exit(1);
    37a8:	4505                	li	a0,1
    ...
    37b8:	c3c50513          	addi	a0,a0,-964 # 73f0 <malloc+0x1c4c>
    37bc:	00002097          	auipc	ra,0x2
    37c0:	f2a080e7          	jalr	-214(ra) # 56e6 <printf>
    exit(1);
    37c4:	4505                	li	a0,1
    ...
    37d4:	c4850513          	addi	a0,a0,-952 # 7418 <malloc+0x1c74>
    37d8:	00002097          	auipc	ra,0x2
    37dc:	f0e080e7          	jalr	-242(ra) # 56e6 <printf>
    exit(1);
    37e0:	4505                	li	a0,1
    ...
    37f0:	c5450513          	addi	a0,a0,-940 # 7440 <malloc+0x1c9c>
    37f4:	00002097          	auipc	ra,0x2
    37f8:	ef2080e7          	jalr	-270(ra) # 56e6 <printf>
    exit(1);
    37fc:	4505                	li	a0,1
    ...
    380c:	c6050513          	addi	a0,a0,-928 # 7468 <malloc+0x1cc4>
    3810:	00002097          	auipc	ra,0x2
    3814:	ed6080e7          	jalr	-298(ra) # 56e6 <printf>
    exit(1);
    3818:	4505                	li	a0,1
    ...
    3828:	c6450513          	addi	a0,a0,-924 # 7488 <malloc+0x1ce4>
    382c:	00002097          	auipc	ra,0x2
    3830:	eba080e7          	jalr	-326(ra) # 56e6 <printf>
    exit(1);
    3834:	4505                	li	a0,1
    ...
    3844:	c7050513          	addi	a0,a0,-912 # 74b0 <malloc+0x1d0c>
    3848:	00002097          	auipc	ra,0x2
    384c:	e9e080e7          	jalr	-354(ra) # 56e6 <printf>
    exit(1);
    3850:	4505                	li	a0,1
...
000000000000385a <iref>:
{
    ...
    3878:	c54a0a13          	addi	s4,s4,-940 # 74c8 <malloc+0x1d24>
    mkdir("");
    387c:	00003497          	auipc	s1,0x3
    3880:	75448493          	addi	s1,s1,1876 # 6fd0 <malloc+0x182c>
    link("README", "");
    3884:	00002a97          	auipc	s5,0x2
    3888:	4dca8a93          	addi	s5,s5,1244 # 5d60 <malloc+0x5bc>
    fd = open("xx", O_CREATE);
    388c:	00004997          	auipc	s3,0x4
    3890:	b3498993          	addi	s3,s3,-1228 # 73c0 <malloc+0x1c1c>
    3894:	a891                	j	38e8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3896:	85da                	mv	a1,s6
    3898:	00004517          	auipc	a0,0x4
    389c:	c3850513          	addi	a0,a0,-968 # 74d0 <malloc+0x1d2c>
    38a0:	00002097          	auipc	ra,0x2
    38a4:	e46080e7          	jalr	-442(ra) # 56e6 <printf>
      exit(1);
    38a8:	4505                	li	a0,1
    ...
    38b8:	c3450513          	addi	a0,a0,-972 # 74e8 <malloc+0x1d44>
    38bc:	00002097          	auipc	ra,0x2
    38c0:	e2a080e7          	jalr	-470(ra) # 56e6 <printf>
      exit(1);
    38c4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    394c:	9a098993          	addi	s3,s3,-1632 # 72e8 <malloc+0x1b44>
    unlink("irefd");
    3950:	00004917          	auipc	s2,0x4
    3954:	b7890913          	addi	s2,s2,-1160 # 74c8 <malloc+0x1d24>
    chdir("..");
    3958:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3974:	38050513          	addi	a0,a0,896 # 6cf0 <malloc+0x154c>
...
0000000000003994 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    39a4:	b6050513          	addi	a0,a0,-1184 # 7500 <malloc+0x1d5c>
  ...
  if(pid == 0){
    ...
    39c8:	b3c50513          	addi	a0,a0,-1220 # 7500 <malloc+0x1d5c>
    ...
    39de:	b4650513          	addi	a0,a0,-1210 # 7520 <malloc+0x1d7c>
    39e2:	00002097          	auipc	ra,0x2
    39e6:	d04080e7          	jalr	-764(ra) # 56e6 <printf>
      exit(1);
    39ea:	4505                	li	a0,1
    ...
    39fa:	b1250513          	addi	a0,a0,-1262 # 7508 <malloc+0x1d64>
    39fe:	00002097          	auipc	ra,0x2
    3a02:	ce8080e7          	jalr	-792(ra) # 56e6 <printf>
    exit(1);
    3a06:	4505                	li	a0,1
    ...
    3a16:	9ee50513          	addi	a0,a0,-1554 # 6400 <malloc+0xc5c>
    3a1a:	00002097          	auipc	ra,0x2
    3a1e:	ccc080e7          	jalr	-820(ra) # 56e6 <printf>
    exit(1);
    3a22:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3a44:	ac050513          	addi	a0,a0,-1344 # 7500 <malloc+0x1d5c>
    ...
    3a58:	b9c50513          	addi	a0,a0,-1124 # 65f0 <malloc+0xe4c>
    3a5c:	00002097          	auipc	ra,0x2
    3a60:	c8a080e7          	jalr	-886(ra) # 56e6 <printf>
    exit(1);
    3a64:	4505                	li	a0,1
...
0000000000003a86 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3a96:	ab650513          	addi	a0,a0,-1354 # 7548 <malloc+0x1da4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ac2:	a8a50513          	addi	a0,a0,-1398 # 7548 <malloc+0x1da4>
  ...
  sleep(10); // one second
    ...
    3afa:	aca50513          	addi	a0,a0,-1334 # 65c0 <malloc+0xe1c>
    3afe:	00002097          	auipc	ra,0x2
    3b02:	be8080e7          	jalr	-1048(ra) # 56e6 <printf>
    exit(1);
    3b06:	4505                	li	a0,1
    ...
    3b14:	a3848493          	addi	s1,s1,-1480 # 7548 <malloc+0x1da4>
    3b18:	4581                	li	a1,0
    3b1a:	8526                	mv	a0,s1
...
0000000000003b56 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3b7e:	a4650513          	addi	a0,a0,-1466 # 65c0 <malloc+0xe1c>
    3b82:	00002097          	auipc	ra,0x2
    3b86:	b64080e7          	jalr	-1180(ra) # 56e6 <printf>
    exit(1);
    3b8a:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3bac:	85850513          	addi	a0,a0,-1960 # 6400 <malloc+0xc5c>
    3bb0:	00002097          	auipc	ra,0x2
    3bb4:	b36080e7          	jalr	-1226(ra) # 56e6 <printf>
    exit(1);
    3bb8:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3bf0:	04c58593          	addi	a1,a1,76 # 5c38 <malloc+0x494>
    ...
    3c1a:	7ea50513          	addi	a0,a0,2026 # 6400 <malloc+0xc5c>
    3c1e:	00002097          	auipc	ra,0x2
    3c22:	ac8080e7          	jalr	-1336(ra) # 56e6 <printf>
     exit(1);
    3c26:	4505                	li	a0,1
    ...
    3c34:	92850513          	addi	a0,a0,-1752 # 7558 <malloc+0x1db4>
    3c38:	00002097          	auipc	ra,0x2
    3c3c:	aae080e7          	jalr	-1362(ra) # 56e6 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3c6e:	90650513          	addi	a0,a0,-1786 # 7570 <malloc+0x1dcc>
    3c72:	00002097          	auipc	ra,0x2
    3c76:	a74080e7          	jalr	-1420(ra) # 56e6 <printf>
}
  ...
  printf("kill... ");
    ...
    3c9a:	8f250513          	addi	a0,a0,-1806 # 7588 <malloc+0x1de4>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	a48080e7          	jalr	-1464(ra) # 56e6 <printf>
  kill(pid1);
    3ca6:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    3cc8:	8d450513          	addi	a0,a0,-1836 # 7598 <malloc+0x1df4>
    3ccc:	00002097          	auipc	ra,0x2
    3cd0:	a1a080e7          	jalr	-1510(ra) # 56e6 <printf>
  wait(0);
    3cd4:	4501                	li	a0,0
...
0000000000003cf4 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3d2a:	7e250513          	addi	a0,a0,2018 # 6508 <malloc+0xd64>
    3d2e:	00002097          	auipc	ra,0x2
    3d32:	9b8080e7          	jalr	-1608(ra) # 56e6 <printf>
    exit(1);
    3d36:	4505                	li	a0,1
    ...
    3d5e:	ede58593          	addi	a1,a1,-290 # 5c38 <malloc+0x494>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3e22:	78a50513          	addi	a0,a0,1930 # 75a8 <malloc+0x1e04>
    3e26:	00002097          	auipc	ra,0x2
    3e2a:	8c0080e7          	jalr	-1856(ra) # 56e6 <printf>
    exit(1);
    3e2e:	4505                	li	a0,1
    ...
    3e3e:	5c650513          	addi	a0,a0,1478 # 6400 <malloc+0xc5c>
    3e42:	00002097          	auipc	ra,0x2
    3e46:	8a4080e7          	jalr	-1884(ra) # 56e6 <printf>
    exit(1);
    3e4a:	4505                	li	a0,1
    ...
    3e74:	6705                	lui	a4,0x1
      n += *(a+i);
    3e76:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f18c0>
    ...
    3e88:	74450513          	addi	a0,a0,1860 # 75c8 <malloc+0x1e24>
    3e8c:	00002097          	auipc	ra,0x2
    3e90:	85a080e7          	jalr	-1958(ra) # 56e6 <printf>
    exit(1);
    3e94:	4505                	li	a0,1
...
0000000000003ea8 <reparent>:
{
  ...
  exit(0);
    ...
    3efc:	50850513          	addi	a0,a0,1288 # 6400 <malloc+0xc5c>
    3f00:	00001097          	auipc	ra,0x1
    3f04:	7e6080e7          	jalr	2022(ra) # 56e6 <printf>
      exit(1);
    3f08:	4505                	li	a0,1
    ...
    3f18:	67450513          	addi	a0,a0,1652 # 6588 <malloc+0xde4>
    3f1c:	00001097          	auipc	ra,0x1
    3f20:	7ca080e7          	jalr	1994(ra) # 56e6 <printf>
        exit(1);
    3f24:	4505                	li	a0,1
...
0000000000003f58 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3fa2:	806080e7          	jalr	-2042(ra) # 57a4 <malloc>
    ...
    3fdc:	62050513          	addi	a0,a0,1568 # 75f8 <malloc+0x1e54>
    3fe0:	00001097          	auipc	ra,0x1
    3fe4:	706080e7          	jalr	1798(ra) # 56e6 <printf>
      exit(1);
    3fe8:	4505                	li	a0,1
...
0000000000003ffc <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4092:	58a50513          	addi	a0,a0,1418 # 7618 <malloc+0x1e74>
    4096:	00001097          	auipc	ra,0x1
    409a:	650080e7          	jalr	1616(ra) # 56e6 <printf>
    exit(1);
    409e:	4505                	li	a0,1
    ...
    40ae:	59650513          	addi	a0,a0,1430 # 7640 <malloc+0x1e9c>
    40b2:	00001097          	auipc	ra,0x1
    40b6:	634080e7          	jalr	1588(ra) # 56e6 <printf>
      exit(1);
    40ba:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    40f2:	92250513          	addi	a0,a0,-1758 # 5a10 <malloc+0x26c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4132:	53250513          	addi	a0,a0,1330 # 7660 <malloc+0x1ebc>
    4136:	00001097          	auipc	ra,0x1
    413a:	5b0080e7          	jalr	1456(ra) # 56e6 <printf>
    exit(1);
    413e:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    416e:	8a650513          	addi	a0,a0,-1882 # 5a10 <malloc+0x26c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4194:	4f850513          	addi	a0,a0,1272 # 7688 <malloc+0x1ee4>
    4198:	00001097          	auipc	ra,0x1
    419c:	54e080e7          	jalr	1358(ra) # 56e6 <printf>
    exit(1);
    41a0:	4505                	li	a0,1
...
00000000000041b4 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    41da:	6ba78793          	addi	a5,a5,1722 # 5890 <malloc+0xec>
    41de:	f6f43823          	sd	a5,-144(s0)
    41e2:	00001797          	auipc	a5,0x1
    41e6:	6b678793          	addi	a5,a5,1718 # 5898 <malloc+0xf4>
    41ea:	f6f43c23          	sd	a5,-136(s0)
    41ee:	00001797          	auipc	a5,0x1
    41f2:	6b278793          	addi	a5,a5,1714 # 58a0 <malloc+0xfc>
    41f6:	f8f43023          	sd	a5,-128(s0)
    41fa:	00001797          	auipc	a5,0x1
    41fe:	6ae78793          	addi	a5,a5,1710 # 58a8 <malloc+0x104>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4256:	4dea0a13          	addi	s4,s4,1246 # b730 <buf>
    425a:	00007a97          	auipc	s5,0x7
    425e:	4d7a8a93          	addi	s5,s5,1239 # b731 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4276:	57e50513          	addi	a0,a0,1406 # 67f0 <malloc+0x104c>
    427a:	00001097          	auipc	ra,0x1
    427e:	46c080e7          	jalr	1132(ra) # 56e6 <printf>
      exit(1);
    4282:	4505                	li	a0,1
    ...
    42f2:	3b250513          	addi	a0,a0,946 # 76a0 <malloc+0x1efc>
    42f6:	00001097          	auipc	ra,0x1
    42fa:	3f0080e7          	jalr	1008(ra) # 56e6 <printf>
        exit(1);
    42fe:	4505                	li	a0,1
    ...
    430c:	3a850513          	addi	a0,a0,936 # 76b0 <malloc+0x1f0c>
    4310:	00001097          	auipc	ra,0x1
    4314:	3d6080e7          	jalr	982(ra) # 56e6 <printf>
          exit(1);
    4318:	4505                	li	a0,1
    ...
    4334:	39850513          	addi	a0,a0,920 # 76c8 <malloc+0x1f24>
    4338:	00001097          	auipc	ra,0x1
    433c:	3ae080e7          	jalr	942(ra) # 56e6 <printf>
          exit(1);
    4340:	4505                	li	a0,1
    ...
    4364:	3d078793          	addi	a5,a5,976 # b730 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    43c2:	31a50513          	addi	a0,a0,794 # 76d8 <malloc+0x1f34>
    43c6:	00001097          	auipc	ra,0x1
    43ca:	320080e7          	jalr	800(ra) # 56e6 <printf>
      exit(1);
    43ce:	4505                	li	a0,1
...
00000000000043f6 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4424:	2d0b8b93          	addi	s7,s7,720 # 76f0 <malloc+0x1f4c>
  for(i = 0; i < N; i++){
    ...
    4466:	29650513          	addi	a0,a0,662 # 76f8 <malloc+0x1f54>
    446a:	00001097          	auipc	ra,0x1
    446e:	27c080e7          	jalr	636(ra) # 56e6 <printf>
        exit(1);
    4472:	4505                	li	a0,1
    ...
    4484:	27050513          	addi	a0,a0,624 # 76f0 <malloc+0x1f4c>
  ...
  fd = open(".", 0);
    ...
    44bc:	da850513          	addi	a0,a0,-600 # 6260 <malloc+0xabc>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4532:	1ea50513          	addi	a0,a0,490 # 7718 <malloc+0x1f74>
    4536:	00001097          	auipc	ra,0x1
    453a:	1b0080e7          	jalr	432(ra) # 56e6 <printf>
        exit(1);
    453e:	4505                	li	a0,1
    ...
    4552:	1ea50513          	addi	a0,a0,490 # 7738 <malloc+0x1f94>
    4556:	00001097          	auipc	ra,0x1
    455a:	190080e7          	jalr	400(ra) # 56e6 <printf>
        exit(1);
    455e:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    458a:	1da50513          	addi	a0,a0,474 # 7760 <malloc+0x1fbc>
    458e:	00001097          	auipc	ra,0x1
    4592:	158080e7          	jalr	344(ra) # 56e6 <printf>
    exit(1);
    4596:	4505                	li	a0,1
    ...
    45a6:	e5e50513          	addi	a0,a0,-418 # 6400 <malloc+0xc5c>
    45aa:	00001097          	auipc	ra,0x1
    45ae:	13c080e7          	jalr	316(ra) # 56e6 <printf>
      exit(1);
    45b2:	4505                	li	a0,1
...
0000000000004750 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4790:	fa490913          	addi	s2,s2,-92 # b730 <buf>
  for(i = 0; i < N; i++){
    4794:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    47d8:	fc450513          	addi	a0,a0,-60 # 7798 <malloc+0x1ff4>
  ...
  for(i = 0; ; i++){
    ...
    47ee:	f4690913          	addi	s2,s2,-186 # b730 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    483c:	f7050513          	addi	a0,a0,-144 # 77a8 <malloc+0x2004>
    4840:	00001097          	auipc	ra,0x1
    4844:	ea6080e7          	jalr	-346(ra) # 56e6 <printf>
    exit(1);
    4848:	4505                	li	a0,1
    ...
    4858:	f7450513          	addi	a0,a0,-140 # 77c8 <malloc+0x2024>
    485c:	00001097          	auipc	ra,0x1
    4860:	e8a080e7          	jalr	-374(ra) # 56e6 <printf>
      exit(1);
    4864:	4505                	li	a0,1
    ...
    4874:	f7850513          	addi	a0,a0,-136 # 77e8 <malloc+0x2044>
    4878:	00001097          	auipc	ra,0x1
    487c:	e6e080e7          	jalr	-402(ra) # 56e6 <printf>
    exit(1);
    4880:	4505                	li	a0,1
    ...
    4890:	f7c50513          	addi	a0,a0,-132 # 7808 <malloc+0x2064>
    4894:	00001097          	auipc	ra,0x1
    4898:	e52080e7          	jalr	-430(ra) # 56e6 <printf>
      exit(1);
    489c:	4505                	li	a0,1
    ...
    48ac:	f8050513          	addi	a0,a0,-128 # 7828 <malloc+0x2084>
    48b0:	00001097          	auipc	ra,0x1
    48b4:	e36080e7          	jalr	-458(ra) # 56e6 <printf>
      exit(1);
    48b8:	4505                	li	a0,1
    ...
    48c8:	f7c50513          	addi	a0,a0,-132 # 7840 <malloc+0x209c>
    48cc:	00001097          	auipc	ra,0x1
    48d0:	e1a080e7          	jalr	-486(ra) # 56e6 <printf>
      exit(1);
    48d4:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    48f6:	ea650513          	addi	a0,a0,-346 # 7798 <malloc+0x1ff4>
    ...
    491a:	f4a50513          	addi	a0,a0,-182 # 7860 <malloc+0x20bc>
    491e:	00001097          	auipc	ra,0x1
    4922:	dc8080e7          	jalr	-568(ra) # 56e6 <printf>
    exit(1);
    4926:	4505                	li	a0,1
...
0000000000004930 <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    4940:	f4450513          	addi	a0,a0,-188 # 7880 <malloc+0x20dc>
    4944:	00001097          	auipc	ra,0x1
    4948:	da2080e7          	jalr	-606(ra) # 56e6 <printf>
  if(mkdir("dir0") < 0){
    494c:	00003517          	auipc	a0,0x3
    4950:	f4450513          	addi	a0,a0,-188 # 7890 <malloc+0x20ec>
  ...
  if(chdir("dir0") < 0){
    ...
    4964:	f3050513          	addi	a0,a0,-208 # 7890 <malloc+0x20ec>
  ...
  if(chdir("..") < 0){
    ...
    4978:	97450513          	addi	a0,a0,-1676 # 72e8 <malloc+0x1b44>
  ...
  if(unlink("dir0") < 0){
    ...
    498c:	f0850513          	addi	a0,a0,-248 # 7890 <malloc+0x20ec>
  ...
  printf("%s: mkdir test ok\n");
    ...
    49a0:	f4450513          	addi	a0,a0,-188 # 78e0 <malloc+0x213c>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	d42080e7          	jalr	-702(ra) # 56e6 <printf>
}
    ...
    49bc:	2d050513          	addi	a0,a0,720 # 6c88 <malloc+0x14e4>
    49c0:	00001097          	auipc	ra,0x1
    49c4:	d26080e7          	jalr	-730(ra) # 56e6 <printf>
    exit(1);
    49c8:	4505                	li	a0,1
    ...
    49d8:	ec450513          	addi	a0,a0,-316 # 7898 <malloc+0x20f4>
    49dc:	00001097          	auipc	ra,0x1
    49e0:	d0a080e7          	jalr	-758(ra) # 56e6 <printf>
    exit(1);
    49e4:	4505                	li	a0,1
    ...
    49f4:	ec050513          	addi	a0,a0,-320 # 78b0 <malloc+0x210c>
    49f8:	00001097          	auipc	ra,0x1
    49fc:	cee080e7          	jalr	-786(ra) # 56e6 <printf>
    exit(1);
    4a00:	4505                	li	a0,1
    ...
    4a10:	ebc50513          	addi	a0,a0,-324 # 78c8 <malloc+0x2124>
    4a14:	00001097          	auipc	ra,0x1
    4a18:	cd2080e7          	jalr	-814(ra) # 56e6 <printf>
    exit(1);
    4a1c:	4505                	li	a0,1
...
0000000000004a26 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4a48:	eb450513          	addi	a0,a0,-332 # 78f8 <malloc+0x2154>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	c9a080e7          	jalr	-870(ra) # 56e6 <printf>
  for(nfiles = 0; ; nfiles++){
    4a54:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4a68:	ea4c8c93          	addi	s9,s9,-348 # 7908 <malloc+0x2164>
    int total = 0;
    4a6c:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4a6e:	00007a17          	auipc	s4,0x7
    4a72:	cc2a0a13          	addi	s4,s4,-830 # b730 <buf>
    name[0] = 'f';
    ...
    4ac0:	c2a080e7          	jalr	-982(ra) # 56e6 <printf>
    ...
    4ae2:	e3a50513          	addi	a0,a0,-454 # 7918 <malloc+0x2174>
    4ae6:	00001097          	auipc	ra,0x1
    4aea:	c00080e7          	jalr	-1024(ra) # 56e6 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4b58:	df450513          	addi	a0,a0,-524 # 7948 <malloc+0x21a4>
    4b5c:	00001097          	auipc	ra,0x1
    4b60:	b8a080e7          	jalr	-1142(ra) # 56e6 <printf>
}
    ...
    4ba8:	d8c50513          	addi	a0,a0,-628 # 7930 <malloc+0x218c>
    4bac:	00001097          	auipc	ra,0x1
    4bb0:	b3a080e7          	jalr	-1222(ra) # 56e6 <printf>
    close(fd);
    4bb4:	854a                	mv	a0,s2
...
0000000000004bc6 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4bd0:	33470713          	addi	a4,a4,820 # 7f00 <randstate>
    4bd4:	6308                	ld	a0,0(a4)
    4bd6:	001967b7          	lui	a5,0x196
    4bda:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187ecd>
    4bde:	02f50533          	mul	a0,a0,a5
    4be2:	3c6ef7b7          	lui	a5,0x3c6ef
    4be6:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e0c1f>
...
0000000000004bf6 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4c6a:	cfa50513          	addi	a0,a0,-774 # 7960 <malloc+0x21bc>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4c82:	fba58593          	addi	a1,a1,-70 # 5c38 <malloc+0x494>
    ...
    4c98:	cec50513          	addi	a0,a0,-788 # 7980 <malloc+0x21dc>
    4c9c:	00001097          	auipc	ra,0x1
    4ca0:	a4a080e7          	jalr	-1462(ra) # 56e6 <printf>
    exit(1);
    4ca4:	4505                	li	a0,1
    ...
    4cb2:	cba50513          	addi	a0,a0,-838 # 7968 <malloc+0x21c4>
    4cb6:	00001097          	auipc	ra,0x1
    4cba:	a30080e7          	jalr	-1488(ra) # 56e6 <printf>
      exit(1);
    4cbe:	4505                	li	a0,1
    ...
    4ccc:	ca050513          	addi	a0,a0,-864 # 7968 <malloc+0x21c4>
    4cd0:	00001097          	auipc	ra,0x1
    4cd4:	a16080e7          	jalr	-1514(ra) # 56e6 <printf>
    exit(1);
    4cd8:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    4cf0:	c7450513          	addi	a0,a0,-908 # 7960 <malloc+0x21bc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4d46:	ef698993          	addi	s3,s3,-266 # 5c38 <malloc+0x494>
      uint64 a = (uint64) sbrk(4096);
    ...
    4d78:	c5c50513          	addi	a0,a0,-932 # 79d0 <malloc+0x222c>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	96a080e7          	jalr	-1686(ra) # 56e6 <printf>
        exit(1);
    4d84:	4505                	li	a0,1
    ...
    4d92:	c0250513          	addi	a0,a0,-1022 # 7990 <malloc+0x21ec>
    4d96:	00001097          	auipc	ra,0x1
    4d9a:	950080e7          	jalr	-1712(ra) # 56e6 <printf>
    exit(1);
    4d9e:	4505                	li	a0,1
    ...
    4dac:	c0850513          	addi	a0,a0,-1016 # 79b0 <malloc+0x220c>
    4db0:	00001097          	auipc	ra,0x1
    4db4:	936080e7          	jalr	-1738(ra) # 56e6 <printf>
    exit(1);
    4db8:	4505                	li	a0,1
  ...
  while(1){
    ...
    4dfa:	bfa50513          	addi	a0,a0,-1030 # 79f0 <malloc+0x224c>
    4dfe:	00001097          	auipc	ra,0x1
    4e02:	8e8080e7          	jalr	-1816(ra) # 56e6 <printf>
      exit(1);
    4e06:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4e4a:	bca50513          	addi	a0,a0,-1078 # 7a10 <malloc+0x226c>
    4e4e:	00001097          	auipc	ra,0x1
    4e52:	898080e7          	jalr	-1896(ra) # 56e6 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4e7a:	bc250513          	addi	a0,a0,-1086 # 7a38 <malloc+0x2294>
    4e7e:	00001097          	auipc	ra,0x1
    4e82:	868080e7          	jalr	-1944(ra) # 56e6 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4e9e:	b8650513          	addi	a0,a0,-1146 # 7a20 <malloc+0x227c>
    4ea2:	00001097          	auipc	ra,0x1
    4ea6:	844080e7          	jalr	-1980(ra) # 56e6 <printf>
    exit(1);
    4eaa:	4505                	li	a0,1
    ...
    4ec6:	b7e50513          	addi	a0,a0,-1154 # 7a40 <malloc+0x229c>
    4eca:	00001097          	auipc	ra,0x1
    4ece:	81c080e7          	jalr	-2020(ra) # 56e6 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    4f0e:	c4e78793          	addi	a5,a5,-946 # 7b58 <malloc+0x23b4>
    4f12:	c4040713          	addi	a4,s0,-960
    4f16:	00003817          	auipc	a6,0x3
    4f1a:	fc280813          	addi	a6,a6,-62 # 7ed8 <malloc+0x2734>
  ...
  printf("usertests starting\n");
    ...
    4f3e:	bbe50513          	addi	a0,a0,-1090 # 7af8 <malloc+0x2354>
    4f42:	00000097          	auipc	ra,0x0
    4f46:	7a4080e7          	jalr	1956(ra) # 56e6 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    4f76:	b3e50513          	addi	a0,a0,-1218 # 7ab0 <malloc+0x230c>
    4f7a:	00000097          	auipc	ra,0x0
    4f7e:	76c080e7          	jalr	1900(ra) # 56e6 <printf>
    exit(1);
    4f82:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    4f92:	aba58593          	addi	a1,a1,-1350 # 7a48 <malloc+0x22a4>
    ...
    4fa8:	b8c58593          	addi	a1,a1,-1140 # 7b30 <malloc+0x238c>
    ...
    4fcc:	a8850513          	addi	a0,a0,-1400 # 7a50 <malloc+0x22ac>
    4fd0:	00000097          	auipc	ra,0x0
    4fd4:	716080e7          	jalr	1814(ra) # 56e6 <printf>
    exit(1);
    4fd8:	4505                	li	a0,1
    ...
    4ff6:	6f4080e7          	jalr	1780(ra) # 56e6 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5038:	a6450513          	addi	a0,a0,-1436 # 7a98 <malloc+0x22f4>
    503c:	00000097          	auipc	ra,0x0
    5040:	6aa080e7          	jalr	1706(ra) # 56e6 <printf>
    exit(1);
    5044:	4505                	li	a0,1
    ...
    5052:	a9250513          	addi	a0,a0,-1390 # 7ae0 <malloc+0x233c>
    5056:	00000097          	auipc	ra,0x0
    505a:	690080e7          	jalr	1680(ra) # 56e6 <printf>
    exit(0);
    505e:	4501                	li	a0,0
    ...
    506e:	67c080e7          	jalr	1660(ra) # 56e6 <printf>
        if(continuous != 2)
    ...
    50b0:	aac78793          	addi	a5,a5,-1364 # 7b58 <malloc+0x23b4>
    50b4:	c4040713          	addi	a4,s0,-960
    50b8:	00003817          	auipc	a6,0x3
    50bc:	e2080813          	addi	a6,a6,-480 # 7ed8 <malloc+0x2734>
    ...
    50e0:	a3450513          	addi	a0,a0,-1484 # 7b10 <malloc+0x236c>
    50e4:	00000097          	auipc	ra,0x0
    50e8:	602080e7          	jalr	1538(ra) # 56e6 <printf>
        printf("SOME TESTS FAILED\n");
    50ec:	00003a97          	auipc	s5,0x3
    50f0:	9aca8a93          	addi	s5,s5,-1620 # 7a98 <malloc+0x22f4>
        if(continuous != 2)
    50f4:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    50f6:	00003b17          	auipc	s6,0x3
    50fa:	982b0b13          	addi	s6,s6,-1662 # 7a78 <malloc+0x22d4>
...
putc(int fd, char c)
{
    ...
    5410:	ec06                	sd	ra,24(sp)
    5412:	e822                	sd	s0,16(sp)
    5414:	1000                	addi	s0,sp,32
    5416:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    541a:	4605                	li	a2,1
    541c:	fef40593          	addi	a1,s0,-17
    5420:	00000097          	auipc	ra,0x0
    5424:	f6e080e7          	jalr	-146(ra) # 538e <write>
}
    5428:	60e2                	ld	ra,24(sp)
    542a:	6442                	ld	s0,16(sp)
    542c:	6105                	addi	sp,sp,32
    542e:	8082                	ret

0000000000005430 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5430:	7139                	addi	sp,sp,-64
    5432:	fc06                	sd	ra,56(sp)
    5434:	f822                	sd	s0,48(sp)
    5436:	f426                	sd	s1,40(sp)
    5438:	f04a                	sd	s2,32(sp)
    543a:	ec4e                	sd	s3,24(sp)
    543c:	0080                	addi	s0,sp,64
    543e:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5440:	c299                	beqz	a3,5446 <printint+0x16>
    5442:	0805c863          	bltz	a1,54d2 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5446:	2581                	sext.w	a1,a1
  neg = 0;
    5448:	4881                	li	a7,0
    544a:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5450:	2601                	sext.w	a2,a2
    5452:	00003517          	auipc	a0,0x3
    5456:	a8e50513          	addi	a0,a0,-1394 # 7ee0 <digits>
    545a:	883a                	mv	a6,a4
    545c:	2705                	addiw	a4,a4,1
    545e:	02c5f7bb          	remuw	a5,a1,a2
    5462:	1782                	slli	a5,a5,0x20
    5464:	9381                	srli	a5,a5,0x20
    5466:	97aa                	add	a5,a5,a0
    5468:	0007c783          	lbu	a5,0(a5)
    546c:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5470:	0005879b          	sext.w	a5,a1
    5474:	02c5d5bb          	divuw	a1,a1,a2
    5478:	0685                	addi	a3,a3,1
    547a:	fec7f0e3          	bgeu	a5,a2,545a <printint+0x2a>
  if(neg)
    547e:	00088b63          	beqz	a7,5494 <printint+0x64>
    buf[i++] = '-';
    5482:	fd040793          	addi	a5,s0,-48
    5486:	973e                	add	a4,a4,a5
    5488:	02d00793          	li	a5,45
    548c:	fef70823          	sb	a5,-16(a4)
    5490:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5494:	02e05863          	blez	a4,54c4 <printint+0x94>
    5498:	fc040793          	addi	a5,s0,-64
    549c:	00e78933          	add	s2,a5,a4
    54a0:	fff78993          	addi	s3,a5,-1
    54a4:	99ba                	add	s3,s3,a4
    54a6:	377d                	addiw	a4,a4,-1
    54a8:	1702                	slli	a4,a4,0x20
    54aa:	9301                	srli	a4,a4,0x20
    54ac:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    54b0:	fff94583          	lbu	a1,-1(s2)
    54b4:	8526                	mv	a0,s1
    54b6:	00000097          	auipc	ra,0x0
    54ba:	f58080e7          	jalr	-168(ra) # 540e <putc>
  while(--i >= 0)
    54be:	197d                	addi	s2,s2,-1
    54c0:	ff3918e3          	bne	s2,s3,54b0 <printint+0x80>
}
    54c4:	70e2                	ld	ra,56(sp)
    54c6:	7442                	ld	s0,48(sp)
    54c8:	74a2                	ld	s1,40(sp)
    54ca:	7902                	ld	s2,32(sp)
    54cc:	69e2                	ld	s3,24(sp)
    54ce:	6121                	addi	sp,sp,64
    54d0:	8082                	ret
    x = -xx;
    54d2:	40b005bb          	negw	a1,a1
    neg = 1;
    54d6:	4885                	li	a7,1
    x = -xx;
    54d8:	bf8d                	j	544a <printint+0x1a>

00000000000054da <vprintf>:
}
...
{
    54da:	7119                	addi	sp,sp,-128
    54dc:	fc86                	sd	ra,120(sp)
    54de:	f8a2                	sd	s0,112(sp)
    54e0:	f4a6                	sd	s1,104(sp)
    54e2:	f0ca                	sd	s2,96(sp)
    54e4:	ecce                	sd	s3,88(sp)
    54e6:	e8d2                	sd	s4,80(sp)
    54e8:	e4d6                	sd	s5,72(sp)
    54ea:	e0da                	sd	s6,64(sp)
    54ec:	fc5e                	sd	s7,56(sp)
    54ee:	f862                	sd	s8,48(sp)
    54f0:	f466                	sd	s9,40(sp)
    54f2:	f06a                	sd	s10,32(sp)
    54f4:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    54f8:	0005c903          	lbu	s2,0(a1)
    54fc:	18090f63          	beqz	s2,569a <vprintf+0x1c0>
    5500:	8aaa                	mv	s5,a0
    5502:	8b32                	mv	s6,a2
    5504:	00158493          	addi	s1,a1,1
  state = 0;
    5508:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    550a:	02500a13          	li	s4,37
      if(c == 'd'){
    550e:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5512:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5516:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    551a:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    551e:	00003b97          	auipc	s7,0x3
    5522:	9c2b8b93          	addi	s7,s7,-1598 # 7ee0 <digits>
    5526:	a839                	j	5544 <vprintf+0x6a>
        putc(fd, c);
    5528:	85ca                	mv	a1,s2
    552a:	8556                	mv	a0,s5
    552c:	00000097          	auipc	ra,0x0
    5530:	ee2080e7          	jalr	-286(ra) # 540e <putc>
    5534:	a019                	j	553a <vprintf+0x60>
    } else if(state == '%'){
    5536:	01498f63          	beq	s3,s4,5554 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    553a:	0485                	addi	s1,s1,1
    553c:	fff4c903          	lbu	s2,-1(s1)
    5540:	14090d63          	beqz	s2,569a <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5544:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5548:	fe0997e3          	bnez	s3,5536 <vprintf+0x5c>
      if(c == '%'){
    554c:	fd479ee3          	bne	a5,s4,5528 <vprintf+0x4e>
        state = '%';
    5550:	89be                	mv	s3,a5
    5552:	b7e5                	j	553a <vprintf+0x60>
      if(c == 'd'){
    5554:	05878063          	beq	a5,s8,5594 <vprintf+0xba>
      } else if(c == 'l') {
    5558:	05978c63          	beq	a5,s9,55b0 <vprintf+0xd6>
      } else if(c == 'x') {
    555c:	07a78863          	beq	a5,s10,55cc <vprintf+0xf2>
      } else if(c == 'p') {
    5560:	09b78463          	beq	a5,s11,55e8 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5564:	07300713          	li	a4,115
    5568:	0ce78663          	beq	a5,a4,5634 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    556c:	06300713          	li	a4,99
    5570:	0ee78e63          	beq	a5,a4,566c <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5574:	11478863          	beq	a5,s4,5684 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5580:	e92080e7          	jalr	-366(ra) # 540e <putc>
        putc(fd, c);
    5584:	85ca                	mv	a1,s2
    5586:	8556                	mv	a0,s5
    5588:	00000097          	auipc	ra,0x0
    558c:	e86080e7          	jalr	-378(ra) # 540e <putc>
      }
      state = 0;
    5590:	4981                	li	s3,0
    5592:	b765                	j	553a <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    5594:	008b0913          	addi	s2,s6,8
    5598:	4685                	li	a3,1
    559a:	4629                	li	a2,10
    559c:	000b2583          	lw	a1,0(s6)
    55a0:	8556                	mv	a0,s5
    55a2:	00000097          	auipc	ra,0x0
    55a6:	e8e080e7          	jalr	-370(ra) # 5430 <printint>
    55aa:	8b4a                	mv	s6,s2
      state = 0;
    55ac:	4981                	li	s3,0
    55ae:	b771                	j	553a <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    55b0:	008b0913          	addi	s2,s6,8
    55b4:	4681                	li	a3,0
    55b6:	4629                	li	a2,10
    55b8:	000b2583          	lw	a1,0(s6)
    55bc:	8556                	mv	a0,s5
    55be:	00000097          	auipc	ra,0x0
    55c2:	e72080e7          	jalr	-398(ra) # 5430 <printint>
    55c6:	8b4a                	mv	s6,s2
      state = 0;
    55c8:	4981                	li	s3,0
    55ca:	bf85                	j	553a <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    55cc:	008b0913          	addi	s2,s6,8
    55d0:	4681                	li	a3,0
    55d2:	4641                	li	a2,16
    55d4:	000b2583          	lw	a1,0(s6)
    55d8:	8556                	mv	a0,s5
    55da:	00000097          	auipc	ra,0x0
    55de:	e56080e7          	jalr	-426(ra) # 5430 <printint>
    55e2:	8b4a                	mv	s6,s2
      state = 0;
    55e4:	4981                	li	s3,0
    55e6:	bf91                	j	553a <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    55e8:	008b0793          	addi	a5,s6,8
    55ec:	f8f43423          	sd	a5,-120(s0)
    55f0:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    55f4:	03000593          	li	a1,48
    55f8:	8556                	mv	a0,s5
    55fa:	00000097          	auipc	ra,0x0
    55fe:	e14080e7          	jalr	-492(ra) # 540e <putc>
  putc(fd, 'x');
    5602:	85ea                	mv	a1,s10
    5604:	8556                	mv	a0,s5
    5606:	00000097          	auipc	ra,0x0
    560a:	e08080e7          	jalr	-504(ra) # 540e <putc>
    560e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5610:	03c9d793          	srli	a5,s3,0x3c
    5614:	97de                	add	a5,a5,s7
    5616:	0007c583          	lbu	a1,0(a5)
    561a:	8556                	mv	a0,s5
    561c:	00000097          	auipc	ra,0x0
    5620:	df2080e7          	jalr	-526(ra) # 540e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5624:	0992                	slli	s3,s3,0x4
    5626:	397d                	addiw	s2,s2,-1
    5628:	fe0914e3          	bnez	s2,5610 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    562c:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5630:	4981                	li	s3,0
    5632:	b721                	j	553a <vprintf+0x60>
        s = va_arg(ap, char*);
    5634:	008b0993          	addi	s3,s6,8
    5638:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    563c:	02090163          	beqz	s2,565e <vprintf+0x184>
        while(*s != 0){
    5640:	00094583          	lbu	a1,0(s2)
    5644:	c9a1                	beqz	a1,5694 <vprintf+0x1ba>
          putc(fd, *s);
    5646:	8556                	mv	a0,s5
    5648:	00000097          	auipc	ra,0x0
    564c:	dc6080e7          	jalr	-570(ra) # 540e <putc>
          s++;
    5650:	0905                	addi	s2,s2,1
        while(*s != 0){
    5652:	00094583          	lbu	a1,0(s2)
    5656:	f9e5                	bnez	a1,5646 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5658:	8b4e                	mv	s6,s3
      state = 0;
    565a:	4981                	li	s3,0
    565c:	bdf9                	j	553a <vprintf+0x60>
          s = "(null)";
    565e:	00003917          	auipc	s2,0x3
    5662:	87a90913          	addi	s2,s2,-1926 # 7ed8 <malloc+0x2734>
        while(*s != 0){
    5666:	02800593          	li	a1,40
    566a:	bff1                	j	5646 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    566c:	008b0913          	addi	s2,s6,8
    5670:	000b4583          	lbu	a1,0(s6)
    5674:	8556                	mv	a0,s5
    5676:	00000097          	auipc	ra,0x0
    567a:	d98080e7          	jalr	-616(ra) # 540e <putc>
    567e:	8b4a                	mv	s6,s2
      state = 0;
    5680:	4981                	li	s3,0
    5682:	bd65                	j	553a <vprintf+0x60>
        putc(fd, c);
    5684:	85d2                	mv	a1,s4
    5686:	8556                	mv	a0,s5
    5688:	00000097          	auipc	ra,0x0
    568c:	d86080e7          	jalr	-634(ra) # 540e <putc>
      state = 0;
    5690:	4981                	li	s3,0
    5692:	b565                	j	553a <vprintf+0x60>
        s = va_arg(ap, char*);
    5694:	8b4e                	mv	s6,s3
      state = 0;
    5696:	4981                	li	s3,0
    5698:	b54d                	j	553a <vprintf+0x60>
    }
  }
}
    569a:	70e6                	ld	ra,120(sp)
    569c:	7446                	ld	s0,112(sp)
    569e:	74a6                	ld	s1,104(sp)
    56a0:	7906                	ld	s2,96(sp)
    56a2:	69e6                	ld	s3,88(sp)
    56a4:	6a46                	ld	s4,80(sp)
    56a6:	6aa6                	ld	s5,72(sp)
    56a8:	6b06                	ld	s6,64(sp)
    56aa:	7be2                	ld	s7,56(sp)
    56ac:	7c42                	ld	s8,48(sp)
    56ae:	7ca2                	ld	s9,40(sp)
    56b0:	7d02                	ld	s10,32(sp)
    56b2:	6de2                	ld	s11,24(sp)
    56b4:	6109                	addi	sp,sp,128
    56b6:	8082                	ret

00000000000056b8 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    56b8:	715d                	addi	sp,sp,-80
    56ba:	ec06                	sd	ra,24(sp)
    56bc:	e822                	sd	s0,16(sp)
    56be:	1000                	addi	s0,sp,32
    56c0:	e010                	sd	a2,0(s0)
    56c2:	e414                	sd	a3,8(s0)
    56c4:	e818                	sd	a4,16(s0)
    56c6:	ec1c                	sd	a5,24(s0)
    56c8:	03043023          	sd	a6,32(s0)
    56cc:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    56d0:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    56d4:	8622                	mv	a2,s0
    56d6:	00000097          	auipc	ra,0x0
    56da:	e04080e7          	jalr	-508(ra) # 54da <vprintf>
}
    56de:	60e2                	ld	ra,24(sp)
    56e0:	6442                	ld	s0,16(sp)
    56e2:	6161                	addi	sp,sp,80
    56e4:	8082                	ret

00000000000056e6 <printf>:

void
printf(const char *fmt, ...)
{
    56e6:	711d                	addi	sp,sp,-96
    56e8:	ec06                	sd	ra,24(sp)
    56ea:	e822                	sd	s0,16(sp)
    56ec:	1000                	addi	s0,sp,32
    56ee:	e40c                	sd	a1,8(s0)
    56f0:	e810                	sd	a2,16(s0)
    56f2:	ec14                	sd	a3,24(s0)
    56f4:	f018                	sd	a4,32(s0)
    56f6:	f41c                	sd	a5,40(s0)
    56f8:	03043823          	sd	a6,48(s0)
    56fc:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5700:	00840613          	addi	a2,s0,8
    5704:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5708:	85aa                	mv	a1,a0
    570a:	4505                	li	a0,1
    570c:	00000097          	auipc	ra,0x0
    5710:	dce080e7          	jalr	-562(ra) # 54da <vprintf>
}
    5714:	60e2                	ld	ra,24(sp)
    5716:	6442                	ld	s0,16(sp)
    5718:	6125                	addi	sp,sp,96
    571a:	8082                	ret

000000000000571c <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    571c:	1141                	addi	sp,sp,-16
    571e:	e422                	sd	s0,8(sp)
    5720:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5722:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5726:	00002797          	auipc	a5,0x2
    572a:	7ea7b783          	ld	a5,2026(a5) # 7f10 <freep>
    572e:	a805                	j	575e <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5730:	4618                	lw	a4,8(a2)
    5732:	9db9                	addw	a1,a1,a4
    5734:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5738:	6398                	ld	a4,0(a5)
    573a:	6318                	ld	a4,0(a4)
    573c:	fee53823          	sd	a4,-16(a0)
    5740:	a091                	j	5784 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5742:	ff852703          	lw	a4,-8(a0)
    5746:	9e39                	addw	a2,a2,a4
    5748:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    574a:	ff053703          	ld	a4,-16(a0)
    574e:	e398                	sd	a4,0(a5)
    5750:	a099                	j	5796 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5752:	6398                	ld	a4,0(a5)
    5754:	00e7e463          	bltu	a5,a4,575c <free+0x40>
    5758:	00e6ea63          	bltu	a3,a4,576c <free+0x50>
{
    575c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    575e:	fed7fae3          	bgeu	a5,a3,5752 <free+0x36>
    5762:	6398                	ld	a4,0(a5)
    5764:	00e6e463          	bltu	a3,a4,576c <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5768:	fee7eae3          	bltu	a5,a4,575c <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    576c:	ff852583          	lw	a1,-8(a0)
    5770:	6390                	ld	a2,0(a5)
    5772:	02059813          	slli	a6,a1,0x20
    5776:	01c85713          	srli	a4,a6,0x1c
    577a:	9736                	add	a4,a4,a3
    577c:	fae60ae3          	beq	a2,a4,5730 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5780:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5784:	4790                	lw	a2,8(a5)
    5786:	02061593          	slli	a1,a2,0x20
    578a:	01c5d713          	srli	a4,a1,0x1c
    578e:	973e                	add	a4,a4,a5
    5790:	fae689e3          	beq	a3,a4,5742 <free+0x26>
  } else
    p->s.ptr = bp;
    5794:	e394                	sd	a3,0(a5)
  freep = p;
    5796:	00002717          	auipc	a4,0x2
    579a:	76f73d23          	sd	a5,1914(a4) # 7f10 <freep>
}
    579e:	6422                	ld	s0,8(sp)
    57a0:	0141                	addi	sp,sp,16
    57a2:	8082                	ret

00000000000057a4 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    57a4:	7139                	addi	sp,sp,-64
    57a6:	fc06                	sd	ra,56(sp)
    57a8:	f822                	sd	s0,48(sp)
    57aa:	f426                	sd	s1,40(sp)
    57ac:	f04a                	sd	s2,32(sp)
    57ae:	ec4e                	sd	s3,24(sp)
    57b0:	e852                	sd	s4,16(sp)
    57b2:	e456                	sd	s5,8(sp)
    57b4:	e05a                	sd	s6,0(sp)
    57b6:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    57b8:	02051493          	slli	s1,a0,0x20
    57bc:	9081                	srli	s1,s1,0x20
    57be:	04bd                	addi	s1,s1,15
    57c0:	8091                	srli	s1,s1,0x4
    57c2:	0014899b          	addiw	s3,s1,1
    57c6:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    57c8:	00002517          	auipc	a0,0x2
    57cc:	74853503          	ld	a0,1864(a0) # 7f10 <freep>
    57d0:	c515                	beqz	a0,57fc <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    57d2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    57d4:	4798                	lw	a4,8(a5)
    57d6:	02977f63          	bgeu	a4,s1,5814 <malloc+0x70>
    57da:	8a4e                	mv	s4,s3
    57dc:	0009871b          	sext.w	a4,s3
    57e0:	6685                	lui	a3,0x1
    57e2:	00d77363          	bgeu	a4,a3,57e8 <malloc+0x44>
    57e6:	6a05                	lui	s4,0x1
    57e8:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    57ec:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    57f0:	00002917          	auipc	s2,0x2
    57f4:	72090913          	addi	s2,s2,1824 # 7f10 <freep>
  if(p == (char*)-1)
    57f8:	5afd                	li	s5,-1
    57fa:	a895                	j	586e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    57fc:	00009797          	auipc	a5,0x9
    5800:	f3478793          	addi	a5,a5,-204 # e730 <base>
    5804:	00002717          	auipc	a4,0x2
    5808:	70f73623          	sd	a5,1804(a4) # 7f10 <freep>
    580c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    580e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5812:	b7e1                	j	57da <malloc+0x36>
      if(p->s.size == nunits)
    5814:	02e48c63          	beq	s1,a4,584c <malloc+0xa8>
        p->s.size -= nunits;
    5818:	4137073b          	subw	a4,a4,s3
    581c:	c798                	sw	a4,8(a5)
        p += p->s.size;
    581e:	02071693          	slli	a3,a4,0x20
    5822:	01c6d713          	srli	a4,a3,0x1c
    5826:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5828:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    582c:	00002717          	auipc	a4,0x2
    5830:	6ea73223          	sd	a0,1764(a4) # 7f10 <freep>
      return (void*)(p + 1);
    5834:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5838:	70e2                	ld	ra,56(sp)
    583a:	7442                	ld	s0,48(sp)
    583c:	74a2                	ld	s1,40(sp)
    583e:	7902                	ld	s2,32(sp)
    5840:	69e2                	ld	s3,24(sp)
    5842:	6a42                	ld	s4,16(sp)
    5844:	6aa2                	ld	s5,8(sp)
    5846:	6b02                	ld	s6,0(sp)
    5848:	6121                	addi	sp,sp,64
    584a:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    584c:	6398                	ld	a4,0(a5)
    584e:	e118                	sd	a4,0(a0)
    5850:	bff1                	j	582c <malloc+0x88>
  hp->s.size = nu;
    5852:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5856:	0541                	addi	a0,a0,16
    5858:	00000097          	auipc	ra,0x0
    585c:	ec4080e7          	jalr	-316(ra) # 571c <free>
  return freep;
    5860:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5864:	d971                	beqz	a0,5838 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5866:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5868:	4798                	lw	a4,8(a5)
    586a:	fa9775e3          	bgeu	a4,s1,5814 <malloc+0x70>
    if(p == freep)
    586e:	00093703          	ld	a4,0(s2)
    5872:	853e                	mv	a0,a5
    5874:	fef719e3          	bne	a4,a5,5866 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5878:	8552                	mv	a0,s4
    587a:	00000097          	auipc	ra,0x0
    587e:	b7c080e7          	jalr	-1156(ra) # 53f6 <sbrk>
  if(p == (char*)-1)
    5882:	fd5518e3          	bne	a0,s5,5852 <malloc+0xae>
        return 0;
    5886:	4501                	li	a0,0
    5888:	bf45                	j	5838 <malloc+0x94>
